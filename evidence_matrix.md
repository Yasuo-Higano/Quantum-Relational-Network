...
主張 263 件 / 依存辺 453 本 / 仮定 40 件 / 反証条件 15 件。
...
| ASM-IEEE754 | trust | active | 46 | 52 | QRN-BRIDGE-012, QRN-BRIDGE-013, QRN-BRIDGE-014, QRN-BRIDGE-015, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 245 | 255 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
