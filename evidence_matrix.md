...
主張 160 件 / 依存辺 240 本 / 仮定 38 件 / 反証条件 15 件。
...
|---|---|---|---|---|---|---|---|
| QRN-C0-001 | C0 | v0.7 | D | 0 | 0 | 0 | 25 |
| QRN-C0-002 | C0 | v4.1 | D | 0 | 0 | 0 | 24 |
...
| QRN-GRAV-001 | C1 | v0.7 | CR | 1 | 3 | 2 | 19 |
...
| QRN-GRAV-005 | C2 | v19.1 | CDR | 2 | 3 | 2 | 15 |
| QRN-GRAV-006 | C4 | v19.2 | CDR | 1 | 3 | 2 | 9 |
| QRN-GRAV-007 | C2 | v19.3 | CDR | 1 | 3 | 2 | 5 |
| QRN-GRAV-008 | C4 | v19.4 | CDR | 1 | 3 | 2 | 8 |
| QRN-GRAV-009 | C2 | v19.5 | CDR | 2 | 2 | 3 | 4 |
| QRN-GRAV-010 | C4 | v19.6 | CDR | 2 | 2 | 2 | 7 |
...
| QRN-GRAV-013 | C4 | v22.2 | CDR | 3 | 2 | 2 | 2 |
| QRN-GRAV-014 | C4 | v22.4 | CDR | 1 | 2 | 2 | 1 |
| QRN-GRAV-015 | C4 | v22.5 | CDR | 2 | 2 | 2 | 0 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 66 | 112 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
...
| ASM-LOWDIM | framework | active | 23 | 53 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
| ASM-GAUSS | framework | active | 30 | 50 | QRN-ARROW-001, QRN-CAUSAL-001, QRN-CAUSAL-002, QRN-CONT-001, … |
...
| ASM-MODK | definition | active | 12 | 33 | QRN-CORE-003, QRN-CORE-014, QRN-GRAV-001, QRN-GRAV-002, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 143 | 153 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CONTINUUM | open | 41 | 70 | readout の残差 residual(N)=A·N^(−p)+B の fit で B≠0 が確立する (格子を細かくしても消えない系統残差)。 |
...
| FAL-AREALAW | open | 4 | 27 | アナログ系 (冷却原子等) で面積則・エンタングルメント第一法則の系統的破れが観測される。 |
