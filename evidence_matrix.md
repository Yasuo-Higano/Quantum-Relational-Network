...
主張 268 件 / 依存辺 468 本 / 仮定 41 件 / 反証条件 15 件。
...
| QRN-BRIDGE-037 | C2 | v34.3 | CDR | 0 | 3 | 1 | 1 |
...
| ASM-IEEE754 | trust | active | 51 | 57 | QRN-BRIDGE-012, QRN-BRIDGE-013, QRN-BRIDGE-014, QRN-BRIDGE-015, … |
...
| ASM-LEAN-TRUST | trust | active | 7 | 49 | QRN-BRIDGE-012, QRN-BRIDGE-013, QRN-BRIDGE-014, QRN-BRIDGE-015, … |
| ASM-KTM | model | active | 2 | 42 | QRN-EXP-003, QRN-LEP-001, QRN-LEP-002, QRN-LEP-003, … |
| ASM-LAYER-SEMANTICS | convention | active | 16 | 42 | QRN-BRIDGE-012, QRN-BRIDGE-013, QRN-BRIDGE-014, QRN-BRIDGE-015, … |
...
| ASM-EXACT-INTEGER | trust | active | 2 | 3 | QRN-BRIDGE-037, QRN-BRIDGE-039, QRN-YUK-034 |
...
|---|---|---|---|---|
| FAL-SUITE | open | 250 | 260 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
