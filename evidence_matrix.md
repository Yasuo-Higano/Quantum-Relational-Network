...
主張 225 件 / 依存辺 388 本 / 仮定 40 件 / 反証条件 15 件。
...
| QRN-GEOM-003 | C3 | v0.7 | CR | 0 | 3 | 2 | 30 |
| QRN-GRAV-001 | C1 | v0.7 | CR | 1 | 3 | 2 | 31 |
| QRN-GRAV-002 | C1 | v0.7 | CR | 0 | 2 | 1 | 0 |
| QRN-BH-001 | C1 | v0.8 | CR | 1 | 1 | 2 | 0 |
| QRN-CAUSAL-001 | C1 | v1.1 | CR | 0 | 3 | 2 | 18 |
| QRN-CAUSAL-002 | C3 | v1.1 | CR | 1 | 3 | 1 | 15 |
| QRN-ER-001 | C3 | v1.2 | CR | 0 | 2 | 1 | 11 |
...
| QRN-ARROW-001 | C3 | v5.1 | CR | 1 | 3 | 1 | 13 |
...
| QRN-CORE-001 | C3 | v6.7 | CR | 2 | 3 | 2 | 11 |
...
| QRN-CORE-002 | C3 | v7.4 | CR | 3 | 3 | 1 | 10 |
...
| QRN-CORE-004 | C3 | v11.4 | CR | 2 | 2 | 2 | 8 |
...
| QRN-CORE-005 | C3 | v15.3 | CDR | 1 | 3 | 2 | 18 |
...
| QRN-BRIDGE-001 | C3 | v28.1 | CDR | 3 | 2 | 2 | 6 |
| QRN-BRIDGE-002 | C3 | v28.2 | CDR | 2 | 2 | 2 | 5 |
| QRN-BRIDGE-003 | C3 | v28.3 | CDR | 1 | 2 | 2 | 4 |
| QRN-META-035 | C5 | v29.0 | DR | 2 | 1 | 1 | 1 |
| QRN-BRIDGE-004 | C3 | v29.1 | CDR | 1 | 2 | 2 | 2 |
| QRN-META-036 | C5 | v29.2 | D | 2 | 1 | 1 | 0 |
| QRN-BRIDGE-005 | C3 | v29.3 | CDR | 1 | 2 | 2 | 0 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 112 | 169 | QRN-ARROW-001, QRN-BORN-001, QRN-BRIDGE-001, QRN-BRIDGE-002, … |
| ASM-SEED | design | active | 13 | 77 | QRN-BH-001, QRN-BORN-001, QRN-COSMO-003, QRN-FIELD-001, … |
| ASM-LOWDIM | framework | active | 23 | 72 | QRN-ARROW-001, QRN-BORN-001, QRN-BRIDGE-001, QRN-BRIDGE-002, … |
| ASM-PDG | data | active | 47 | 70 | QRN-COSMO-001, QRN-COSMO-002, QRN-COSMO-003, QRN-DS-002, … |
| ASM-GAUSS | framework | active | 43 | 69 | QRN-ARROW-001, QRN-BRIDGE-001, QRN-BRIDGE-002, QRN-BRIDGE-003, … |
...
| ASM-Z2-MINIMAL | model | active | 2 | 20 | QRN-BRIDGE-002, QRN-BRIDGE-003, QRN-BRIDGE-004, QRN-BRIDGE-005, … |
| ASM-WINDOW-U1SQ | window | active | 2 | 17 | QRN-GAUGE-009, QRN-GAUGE-012, QRN-LEP-001, QRN-LEP-002, … |
| ASM-INIT | model | active | 1 | 16 | QRN-ARROW-001, QRN-BRIDGE-001, QRN-BRIDGE-002, QRN-BRIDGE-003, … |
| ASM-SMCONTENT | data | active | 2 | 16 | QRN-GAUGE-009, QRN-LEP-001, QRN-LEP-002, QRN-LEP-003, … |
| ASM-DOF-GROWTH | model | active | 2 | 14 | QRN-ARROW-001, QRN-BRIDGE-001, QRN-BRIDGE-002, QRN-BRIDGE-003, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 207 | 217 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CONTINUUM | open | 61 | 95 | readout の残差 residual(N)=A·N^(−p)+B の fit で B≠0 が確立する (格子を細かくしても消えない系統残差)。 |
