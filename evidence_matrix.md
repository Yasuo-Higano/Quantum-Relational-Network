...
主張 220 件 / 依存辺 381 本 / 仮定 40 件 / 反証条件 15 件。
...
| QRN-GEOM-003 | C3 | v0.7 | CR | 0 | 3 | 2 | 25 |
| QRN-GRAV-001 | C1 | v0.7 | CR | 1 | 3 | 2 | 31 |
| QRN-GRAV-002 | C1 | v0.7 | CR | 0 | 2 | 1 | 0 |
| QRN-BH-001 | C1 | v0.8 | CR | 1 | 1 | 2 | 0 |
| QRN-CAUSAL-001 | C1 | v1.1 | CR | 0 | 3 | 2 | 13 |
| QRN-CAUSAL-002 | C3 | v1.1 | CR | 1 | 3 | 1 | 10 |
| QRN-ER-001 | C3 | v1.2 | CR | 0 | 2 | 1 | 6 |
...
| QRN-ARROW-001 | C3 | v5.1 | CR | 1 | 3 | 1 | 8 |
...
| QRN-CORE-001 | C3 | v6.7 | CR | 2 | 3 | 2 | 6 |
...
| QRN-CORE-002 | C3 | v7.4 | CR | 3 | 3 | 1 | 5 |
...
| QRN-CORE-004 | C3 | v11.4 | CR | 2 | 2 | 2 | 3 |
...
| QRN-CORE-005 | C3 | v15.3 | CDR | 1 | 3 | 2 | 13 |
...
| QRN-BRIDGE-001 | C3 | v28.1 | CDR | 3 | 2 | 2 | 1 |
| QRN-BRIDGE-002 | C3 | v28.2 | CDR | 2 | 2 | 2 | 0 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 109 | 164 | QRN-ARROW-001, QRN-BORN-001, QRN-BRIDGE-001, QRN-BRIDGE-002, … |
...
| ASM-LOWDIM | framework | active | 23 | 67 | QRN-ARROW-001, QRN-BORN-001, QRN-BRIDGE-001, QRN-BRIDGE-002, … |
...
| ASM-GAUSS | framework | active | 40 | 64 | QRN-ARROW-001, QRN-BRIDGE-001, QRN-BRIDGE-002, QRN-CAUSAL-001, … |
...
| ASM-Z2-MINIMAL | model | active | 2 | 15 | QRN-BRIDGE-002, QRN-CONT-001, QRN-CORE-005, QRN-META-016, … |
| ASM-LEAN-TRUST | trust | active | 6 | 12 | QRN-GAUGE-011, QRN-GAUGE-013, QRN-GAUGE-016, QRN-GAUGE-017, … |
| ASM-INIT | model | active | 1 | 11 | QRN-ARROW-001, QRN-BRIDGE-001, QRN-BRIDGE-002, QRN-CAUSAL-002, … |
| ASM-DOF-GROWTH | model | active | 2 | 9 | QRN-ARROW-001, QRN-BRIDGE-001, QRN-BRIDGE-002, QRN-CORE-002, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 202 | 212 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CONTINUUM | open | 58 | 90 | readout の残差 residual(N)=A·N^(−p)+B の fit で B≠0 が確立する (格子を細かくしても消えない系統残差)。 |
