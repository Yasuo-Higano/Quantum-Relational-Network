...
主張 107 件 / 依存辺 131 本 / 仮定 38 件 / 反証条件 15 件。
...
| QRN-C0-005 | C0 | v2.3 | D | 0 | 0 | 0 | 45 |
| QRN-C0-006 | C0 | v3.2 | D | 0 | 0 | 0 | 29 |
...
| QRN-YUK-002 | C4 | v6.5 | CR | 2 | 3 | 2 | 26 |
...
| QRN-YUK-003 | C4 | v7.2 | CR | 3 | 7 | 2 | 24 |
| QRN-EXP-003 | C4 | v7.3 | CR | 1 | 1 | 2 | 6 |
| QRN-CORE-002 | C3 | v7.4 | CR | 3 | 3 | 1 | 3 |
| QRN-GAUGE-013 | C2 | v7.5 | LR | 1 | 6 | 1 | 1 |
| QRN-YUK-004 | C4 | v8.1 | CR | 1 | 7 | 2 | 22 |
...
| QRN-YUK-005 | C4 | v9.1 | CR | 1 | 7 | 2 | 20 |
| QRN-YUK-006 | C4 | v9.2 | CR | 3 | 6 | 1 | 19 |
| QRN-CORE-003 | C1 | v9.4 | CR | 1 | 4 | 1 | 1 |
| QRN-META-009 | C5 | v10.0 | DR | 3 | 0 | 1 | 0 |
| QRN-YUK-007 | C4 | v10.1 | CR | 1 | 7 | 2 | 17 |
...
| QRN-PRED-001 | C4 | v15.7 | CDR | 2 | 8 | 3 | 4 |
| QRN-META-016 | C5 | v16.0 | DR | 7 | 0 | 1 | 0 |
| QRN-YUK-016 | C4 | v16.1 | CDR | 1 | 5 | 1 | 0 |
| QRN-YUK-017 | C3 | v16.2 | CDR | 2 | 4 | 1 | 2 |
| QRN-YUK-018 | C4 | v16.3 | CDR | 2 | 7 | 2 | 1 |
| QRN-YUK-019 | C4 | v16.4 | CDR | 1 | 7 | 2 | 0 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 24 | 61 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
| ASM-SEED | design | active | 13 | 42 | QRN-BH-001, QRN-BORN-001, QRN-COSMO-003, QRN-FIELD-001, … |
| ASM-LOWDIM | framework | active | 23 | 34 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
| ASM-PDG | data | active | 23 | 34 | QRN-COSMO-001, QRN-COSMO-002, QRN-COSMO-003, QRN-DS-002, … |
| ASM-GAUSS | framework | active | 20 | 31 | QRN-ARROW-001, QRN-CAUSAL-001, QRN-CAUSAL-002, QRN-CONT-001, … |
| ASM-TORUS | model | active | 21 | 29 | QRN-KK-001, QRN-MATTER-001, QRN-META-007, QRN-META-008, … |
| ASM-PRIOR | design | active | 19 | 29 | QRN-META-006, QRN-META-007, QRN-META-008, QRN-META-009, … |
| ASM-OVERLAP | model | active | 18 | 26 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-WILSON-GRID | design | active | 18 | 26 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-DIAGPAIR | model | falsified | 4 | 25 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-STABLE-LABEL | convention | active | 12 | 25 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
...
| ASM-SIGMA-DATA | model | active | 7 | 18 | QRN-META-010, QRN-META-011, QRN-META-012, QRN-META-013, … |
...
| ASM-KTM | model | active | 2 | 7 | QRN-EXP-003, QRN-META-007, QRN-META-016, QRN-PRED-001, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 91 | 101 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CKM-OOS | open | 11 | 28 | out-of-sample の CKM/PMNS 予測が系統的に失敗する (holdout 量が帯を外れる)。 |
...
| FAL-BMV | open | 7 | 12 | BMV 型実験で、QRN の予測位相 Δφ=Gm²τΔx²/(ħd³) にて C≡0 かつ (C,V) が古典包絡 (C=0, V≤e^(−Δφ/2)) の内側に留まる。 |
