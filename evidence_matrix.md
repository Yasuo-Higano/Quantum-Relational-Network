...
主張 151 件 / 依存辺 229 本 / 仮定 38 件 / 反証条件 15 件。
...
| QRN-CORE-006 | C2 | v20.1 | CDR | 0 | 1 | 2 | 8 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 60 | 104 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 134 | 144 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CONTINUUM | open | 36 | 62 | readout の残差 residual(N)=A·N^(−p)+B の fit で B≠0 が確立する (格子を細かくしても消えない系統残差)。 |
