...
主張 178 件 / 依存辺 288 本 / 仮定 38 件 / 反証条件 15 件。
...
| QRN-GRAV-024 | C2 | v24.1 | CDR | 0 | 1 | 1 | 6 |
| QRN-GRAV-025 | C2 | v24.2 | CDR | 1 | 1 | 1 | 5 |
| QRN-GRAV-026 | C4 | v24.3 | CDR | 1 | 1 | 2 | 3 |
| QRN-GRAV-027 | C4 | v24.4 | CDR | 2 | 1 | 2 | 2 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 81 | 130 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 161 | 171 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CONTINUUM | open | 53 | 85 | readout の残差 residual(N)=A·N^(−p)+B の fit で B≠0 が確立する (格子を細かくしても消えない系統残差)。 |
