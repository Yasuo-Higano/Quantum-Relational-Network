...
主張 218 件 / 依存辺 376 本 / 仮定 40 件 / 反証条件 15 件。
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 107 | 162 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 200 | 210 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
