...
主張 158 件 / 依存辺 237 本 / 仮定 38 件 / 反証条件 15 件。
...
|---|---|---|---|---|---|---|---|
| QRN-C0-001 | C0 | v0.7 | D | 0 | 0 | 0 | 23 |
| QRN-C0-002 | C0 | v4.1 | D | 0 | 0 | 0 | 22 |
...
| QRN-GRAV-001 | C1 | v0.7 | CR | 1 | 3 | 2 | 17 |
...
| QRN-GRAV-005 | C2 | v19.1 | CDR | 2 | 3 | 2 | 13 |
| QRN-GRAV-006 | C4 | v19.2 | CDR | 1 | 3 | 2 | 7 |
| QRN-GRAV-007 | C2 | v19.3 | CDR | 1 | 3 | 2 | 5 |
| QRN-GRAV-008 | C4 | v19.4 | CDR | 1 | 3 | 2 | 6 |
| QRN-GRAV-009 | C2 | v19.5 | CDR | 2 | 2 | 3 | 4 |
| QRN-GRAV-010 | C4 | v19.6 | CDR | 2 | 2 | 2 | 5 |
...
| QRN-GRAV-013 | C4 | v22.2 | CDR | 3 | 2 | 2 | 0 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 64 | 110 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
...
| ASM-LOWDIM | framework | active | 23 | 51 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
| ASM-SIGMA-DATA | model | active | 31 | 49 | QRN-LEP-001, QRN-LEP-002, QRN-LEP-003, QRN-LEP-004, … |
| ASM-GAUSS | framework | active | 28 | 48 | QRN-ARROW-001, QRN-CAUSAL-001, QRN-CAUSAL-002, QRN-CONT-001, … |
...
| ASM-MODK | definition | active | 12 | 31 | QRN-CORE-003, QRN-CORE-014, QRN-GRAV-001, QRN-GRAV-002, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 141 | 151 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CONTINUUM | open | 39 | 68 | readout の残差 residual(N)=A·N^(−p)+B の fit で B≠0 が確立する (格子を細かくしても消えない系統残差)。 |
...
| FAL-AREALAW | open | 4 | 25 | アナログ系 (冷却原子等) で面積則・エンタングルメント第一法則の系統的破れが観測される。 |
