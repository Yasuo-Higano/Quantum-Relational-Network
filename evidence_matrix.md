...
主張 104 件 / 依存辺 126 本 / 仮定 38 件 / 反証条件 15 件。
...
| QRN-C0-005 | C0 | v2.3 | D | 0 | 0 | 0 | 42 |
| QRN-C0-006 | C0 | v3.2 | D | 0 | 0 | 0 | 26 |
...
| QRN-MATTER-001 | C1 | v2.3 | CR | 1 | 2 | 1 | 24 |
...
| QRN-YUK-001 | C4 | v3.2 | CR | 1 | 3 | 2 | 24 |
...
| QRN-YUK-002 | C4 | v6.5 | CR | 2 | 3 | 2 | 23 |
...
| QRN-YUK-005 | C4 | v9.1 | CR | 1 | 7 | 2 | 17 |
| QRN-YUK-006 | C4 | v9.2 | CR | 3 | 6 | 1 | 16 |
| QRN-CORE-003 | C1 | v9.4 | CR | 1 | 4 | 1 | 1 |
| QRN-META-009 | C5 | v10.0 | DR | 3 | 0 | 1 | 0 |
| QRN-YUK-007 | C4 | v10.1 | CR | 1 | 7 | 2 | 14 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 24 | 58 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
| ASM-SEED | design | active | 13 | 39 | QRN-BH-001, QRN-BORN-001, QRN-COSMO-003, QRN-FIELD-001, … |
...
| ASM-PDG | data | active | 21 | 31 | QRN-COSMO-001, QRN-COSMO-002, QRN-COSMO-003, QRN-DS-002, … |
| ASM-TORUS | model | active | 18 | 26 | QRN-KK-001, QRN-MATTER-001, QRN-META-007, QRN-META-008, … |
| ASM-PRIOR | design | active | 17 | 26 | QRN-META-006, QRN-META-007, QRN-META-008, QRN-META-009, … |
| ASM-GAUGE-GROUP | model | active | 14 | 23 | QRN-GAUGE-003, QRN-GAUGE-004, QRN-GAUGE-006, QRN-GAUGE-007, … |
| ASM-OVERLAP | model | active | 15 | 23 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-WILSON-GRID | design | active | 15 | 23 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-DIAGPAIR | model | falsified | 4 | 22 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-ANOMALY-COEFS | data | active | 14 | 22 | QRN-GAUGE-003, QRN-GAUGE-006, QRN-GAUGE-007, QRN-GAUGE-008, … |
| ASM-STABLE-LABEL | convention | active | 9 | 22 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
...
| ASM-SIGMA-DATA | model | active | 5 | 15 | QRN-META-010, QRN-META-011, QRN-META-012, QRN-META-013, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 88 | 98 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CEX-WINDOW | open | 15 | 27 | 明示された探索窓の内側で反例 (条件を満たす非 SM 解、または SM が条件を満たさないこと) が提示される。 |
| FAL-CKM-OOS | open | 9 | 25 | out-of-sample の CKM/PMNS 予測が系統的に失敗する (holdout 量が帯を外れる)。 |
