...
主張 115 件 / 依存辺 145 本 / 仮定 38 件 / 反証条件 15 件。
...
| QRN-C0-005 | C0 | v2.3 | D | 0 | 0 | 0 | 53 |
| QRN-C0-006 | C0 | v3.2 | D | 0 | 0 | 0 | 37 |
...
| QRN-YUK-002 | C4 | v6.5 | CR | 2 | 3 | 2 | 34 |
...
| QRN-YUK-003 | C4 | v7.2 | CR | 3 | 7 | 2 | 32 |
| QRN-EXP-003 | C4 | v7.3 | CR | 1 | 1 | 2 | 14 |
| QRN-CORE-002 | C3 | v7.4 | CR | 3 | 3 | 1 | 3 |
| QRN-GAUGE-013 | C2 | v7.5 | LR | 1 | 6 | 1 | 1 |
| QRN-YUK-004 | C4 | v8.1 | CR | 1 | 7 | 2 | 30 |
...
| QRN-YUK-005 | C4 | v9.1 | CR | 1 | 7 | 2 | 28 |
| QRN-YUK-006 | C4 | v9.2 | CR | 3 | 6 | 1 | 27 |
| QRN-CORE-003 | C1 | v9.4 | CR | 1 | 4 | 1 | 1 |
| QRN-META-009 | C5 | v10.0 | DR | 3 | 0 | 1 | 0 |
| QRN-YUK-007 | C4 | v10.1 | CR | 1 | 7 | 2 | 25 |
...
| QRN-PRED-001 | C4 | v15.7 | CDR | 2 | 8 | 3 | 12 |
| QRN-META-016 | C5 | v16.0 | DR | 7 | 0 | 1 | 0 |
| QRN-YUK-016 | C4 | v16.1 | CDR | 1 | 5 | 1 | 0 |
| QRN-YUK-017 | C3 | v16.2 | CDR | 2 | 4 | 1 | 10 |
| QRN-YUK-018 | C4 | v16.3 | CDR | 2 | 7 | 2 | 9 |
| QRN-YUK-019 | C4 | v16.4 | CDR | 1 | 7 | 2 | 8 |
| QRN-YUK-020 | C4 | v16.5 | CDR | 1 | 7 | 2 | 0 |
| QRN-YUK-021 | C4 | v16.6 | CDR | 1 | 7 | 1 | 0 |
| QRN-YUK-022 | C4 | v16.7 | CDR | 1 | 8 | 2 | 5 |
| QRN-YUK-023 | C4 | v16.8 | CDR | 2 | 8 | 2 | 4 |
| QRN-YUK-024 | C4 | v16.9 | CDR | 2 | 8 | 2 | 3 |
| QRN-YUK-025 | C4 | v16.10 | CDR | 2 | 8 | 2 | 0 |
| QRN-SEL-002 | C4 | v16.11 | CDR | 2 | 8 | 2 | 1 |
| QRN-SEL-003 | C4 | v16.12 | CDR | 3 | 8 | 2 | 0 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 30 | 69 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
| ASM-SEED | design | active | 13 | 50 | QRN-BH-001, QRN-BORN-001, QRN-COSMO-003, QRN-FIELD-001, … |
| ASM-PDG | data | active | 31 | 42 | QRN-COSMO-001, QRN-COSMO-002, QRN-COSMO-003, QRN-DS-002, … |
| ASM-TORUS | model | active | 29 | 37 | QRN-KK-001, QRN-MATTER-001, QRN-META-007, QRN-META-008, … |
| ASM-PRIOR | design | active | 27 | 37 | QRN-META-006, QRN-META-007, QRN-META-008, QRN-META-009, … |
| ASM-LOWDIM | framework | active | 23 | 34 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
| ASM-OVERLAP | model | active | 26 | 34 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-WILSON-GRID | design | active | 26 | 34 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-DIAGPAIR | model | falsified | 4 | 33 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-STABLE-LABEL | convention | active | 20 | 33 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-GAUSS | framework | active | 20 | 31 | QRN-ARROW-001, QRN-CAUSAL-001, QRN-CAUSAL-002, QRN-CONT-001, … |
| ASM-SIGMA-DATA | model | active | 15 | 26 | QRN-META-010, QRN-META-011, QRN-META-012, QRN-META-013, … |
...
| ASM-KTM | model | active | 2 | 15 | QRN-EXP-003, QRN-META-007, QRN-META-016, QRN-PRED-001, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 99 | 109 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CKM-OOS | open | 12 | 36 | out-of-sample の CKM/PMNS 予測が系統的に失敗する (holdout 量が帯を外れる)。 |
| FAL-CEX-WINDOW | open | 15 | 27 | 明示された探索窓の内側で反例 (条件を満たす非 SM 解、または SM が条件を満たさないこと) が提示される。 |
| FAL-CONTINUUM | open | 13 | 27 | readout の残差 residual(N)=A·N^(−p)+B の fit で B≠0 が確立する (格子を細かくしても消えない系統残差)。 |
| FAL-BMV | open | 7 | 20 | BMV 型実験で、QRN の予測位相 Δφ=Gm²τΔx²/(ħd³) にて C≡0 かつ (C,V) が古典包絡 (C=0, V≤e^(−Δφ/2)) の内側に留まる。 |
