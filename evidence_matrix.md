...
主張 103 件 / 依存辺 125 本 / 仮定 38 件 / 反証条件 15 件。
...
| QRN-C0-005 | C0 | v2.3 | D | 0 | 0 | 0 | 41 |
| QRN-C0-006 | C0 | v3.2 | D | 0 | 0 | 0 | 25 |
...
| QRN-YUK-002 | C4 | v6.5 | CR | 2 | 3 | 2 | 22 |
...
| QRN-YUK-003 | C4 | v7.2 | CR | 3 | 7 | 2 | 20 |
| QRN-EXP-003 | C4 | v7.3 | CR | 1 | 1 | 2 | 3 |
| QRN-CORE-002 | C3 | v7.4 | CR | 3 | 3 | 1 | 3 |
| QRN-GAUGE-013 | C2 | v7.5 | LR | 1 | 6 | 1 | 1 |
| QRN-YUK-004 | C4 | v8.1 | CR | 1 | 7 | 2 | 18 |
...
| QRN-YUK-005 | C4 | v9.1 | CR | 1 | 7 | 2 | 16 |
| QRN-YUK-006 | C4 | v9.2 | CR | 3 | 6 | 1 | 15 |
| QRN-CORE-003 | C1 | v9.4 | CR | 1 | 4 | 1 | 1 |
| QRN-META-009 | C5 | v10.0 | DR | 3 | 0 | 1 | 0 |
| QRN-YUK-007 | C4 | v10.1 | CR | 1 | 7 | 2 | 13 |
...
| QRN-PRED-001 | C4 | v15.7 | CDR | 2 | 8 | 3 | 1 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 24 | 57 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
| ASM-SEED | design | active | 13 | 38 | QRN-BH-001, QRN-BORN-001, QRN-COSMO-003, QRN-FIELD-001, … |
...
| ASM-PDG | data | active | 20 | 30 | QRN-COSMO-001, QRN-COSMO-002, QRN-COSMO-003, QRN-DS-002, … |
| ASM-TORUS | model | active | 17 | 25 | QRN-KK-001, QRN-MATTER-001, QRN-META-007, QRN-META-008, … |
| ASM-PRIOR | design | active | 16 | 25 | QRN-META-006, QRN-META-007, QRN-META-008, QRN-META-009, … |
| ASM-GAUGE-GROUP | model | active | 14 | 23 | QRN-GAUGE-003, QRN-GAUGE-004, QRN-GAUGE-006, QRN-GAUGE-007, … |
| ASM-OVERLAP | model | active | 14 | 22 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-WILSON-GRID | design | active | 14 | 22 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
| ASM-ANOMALY-COEFS | data | active | 14 | 22 | QRN-GAUGE-003, QRN-GAUGE-006, QRN-GAUGE-007, QRN-GAUGE-008, … |
| ASM-DIAGPAIR | model | falsified | 4 | 21 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
...
| ASM-STABLE-LABEL | convention | active | 9 | 21 | QRN-META-007, QRN-META-008, QRN-META-009, QRN-META-010, … |
...
| ASM-SIGMA-DATA | model | active | 5 | 14 | QRN-META-010, QRN-META-011, QRN-META-012, QRN-META-013, … |
...
| ASM-KTM | model | active | 2 | 4 | QRN-EXP-003, QRN-META-007, QRN-META-016, QRN-PRED-001 |
...
|---|---|---|---|---|
| FAL-SUITE | open | 87 | 97 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
| FAL-CEX-WINDOW | open | 15 | 26 | 明示された探索窓の内側で反例 (条件を満たす非 SM 解、または SM が条件を満たさないこと) が提示される。 |
| FAL-CKM-OOS | open | 9 | 24 | out-of-sample の CKM/PMNS 予測が系統的に失敗する (holdout 量が帯を外れる)。 |
| FAL-CONTINUUM | open | 7 | 21 | readout の残差 residual(N)=A·N^(−p)+B の fit で B≠0 が確立する (格子を細かくしても消えない系統残差)。 |
| FAL-EXOTIC-CHIRAL | open | 4 | 16 | SM 1 世代の外のカイラル物質 (第 4 世代・分数電荷ハドロン・エキゾチック表現) が発見される。 |
| FAL-BMV | open | 7 | 9 | BMV 型実験で、QRN の予測位相 Δφ=Gm²τΔx²/(ħd³) にて C≡0 かつ (C,V) が古典包絡 (C=0, V≤e^(−Δφ/2)) の内側に留まる。 |
