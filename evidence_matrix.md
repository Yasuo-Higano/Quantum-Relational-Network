...
主張 217 件 / 依存辺 371 本 / 仮定 40 件 / 反証条件 15 件。
...
| QRN-META-015 | C2 | v15.1 | CDR | 0 | 1 | 1 | 18 |
...
| QRN-META-029 | C2 | v27.1 | CDR | 1 | 1 | 1 | 4 |
| QRN-META-030 | C5 | v27.1 | D | 2 | 1 | 1 | 0 |
| QRN-META-031 | C2 | v27.2 | CDR | 1 | 2 | 1 | 2 |
| QRN-META-032 | C2 | v27.3 | CDR | 2 | 1 | 1 | 1 |
| QRN-META-033 | C2 | v27.4 | CDR | 2 | 1 | 1 | 0 |
...
| ASM-EDGE-SEMANTICS | design | active | 2 | 19 | QRN-META-015, QRN-META-016, QRN-META-017, QRN-META-018, … |
...
| ASM-LEAN-TRUST | trust | active | 6 | 11 | QRN-GAUGE-011, QRN-GAUGE-013, QRN-GAUGE-016, QRN-GAUGE-017, … |
...
| ASM-LAYER-SEMANTICS | convention | active | 5 | 5 | QRN-META-029, QRN-META-030, QRN-META-031, QRN-META-032, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 199 | 209 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
