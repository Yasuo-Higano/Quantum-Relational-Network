...
主張 154 件 / 依存辺 230 本 / 仮定 38 件 / 反証条件 15 件。
...
|---|---|---|---|---|---|---|---|
| QRN-C0-001 | C0 | v0.7 | D | 0 | 0 | 0 | 19 |
| QRN-C0-002 | C0 | v4.1 | D | 0 | 0 | 0 | 18 |
...
| QRN-GRAV-001 | C1 | v0.7 | CR | 1 | 3 | 2 | 13 |
...
| QRN-GRAV-005 | C2 | v19.1 | CDR | 2 | 3 | 2 | 9 |
...
| ASM-MODK | definition | active | 12 | 27 | QRN-CORE-003, QRN-GRAV-001, QRN-GRAV-002, QRN-GRAV-003, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 137 | 147 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
...
| FAL-AREALAW | open | 4 | 21 | アナログ系 (冷却原子等) で面積則・エンタングルメント第一法則の系統的破れが観測される。 |
