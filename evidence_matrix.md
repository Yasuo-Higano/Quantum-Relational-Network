...
主張 194 件 / 依存辺 322 本 / 仮定 39 件 / 反証条件 15 件。
...
| QRN-GRAV-035 | C1 | v26.2 | CDR | 0 | 1 | 1 | 7 |
...
|---|---|---|---|---|---|
| ASM-LATTICE | framework | active | 91 | 142 | QRN-ARROW-001, QRN-BORN-001, QRN-CAUSAL-001, QRN-CAUSAL-002, … |
...
|---|---|---|---|---|
| FAL-SUITE | open | 176 | 186 | 再現スイートの回帰 FAIL — コードの再実行が主張の数値を再現しない (乱数は固定シード)。 |
