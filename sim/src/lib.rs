...
pub mod factorization_enumerator; // sector-aware factorization candidate enumerator (v34.4, PROMPT/15)
pub mod finite_data; // 有限データ証明書 — 同時信頼集合と Robust Promotion (v34.3, PROMPT/15)
