...
rust_closure('QRN-C0-001', 31).
rust_depth('QRN-C0-002', 0).
rust_closure('QRN-C0-002', 30).
...
rust_closure('QRN-GRAV-013', 8).
rust_depth('QRN-GRAV-014', 7).
rust_closure('QRN-GRAV-014', 7).
rust_depth('QRN-GRAV-015', 8).
rust_closure('QRN-GRAV-015', 6).
rust_depth('QRN-GRAV-016', 9).
rust_closure('QRN-GRAV-016', 5).
rust_depth('QRN-GRAV-017', 10).
rust_closure('QRN-GRAV-017', 4).
...
rust_closure('QRN-GRAV-018', 2).
rust_depth('QRN-GRAV-019', 12).
rust_closure('QRN-GRAV-019', 1).
rust_depth('QRN-GRAV-020', 13).
rust_closure('QRN-GRAV-020', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 119).
rust_blast_asm('ASM-GAUSS', 56).
rust_blast_asm('ASM-LOWDIM', 59).
...
rust_blast_fal('FAL-SUITE', 160).
rust_blast_fal('FAL-CEX-WINDOW', 38).
rust_blast_fal('FAL-QNEC', 14).
rust_blast_fal('FAL-CONTINUUM', 77).
