...
rust_closure('QRN-C0-005', 46).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 30).
...
rust_closure('QRN-MATTER-001', 28).
...
rust_closure('QRN-YUK-003', 25).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 7).
...
rust_closure('QRN-YUK-005', 21).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 20).
...
rust_blast_asm('ASM-SIGMA-DATA', 19).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 8).
rust_blast_asm('ASM-DIAGPAIR', 26).
...
rust_blast_asm('ASM-TORUS', 30).
rust_blast_asm('ASM-OVERLAP', 27).
rust_blast_asm('ASM-WILSON-GRID', 27).
...
rust_blast_asm('ASM-PDG', 35).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 43).
rust_blast_asm('ASM-PRIOR', 30).
rust_blast_asm('ASM-STABLE-LABEL', 26).
...
rust_blast_fal('FAL-CKM-OOS', 29).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 102).
