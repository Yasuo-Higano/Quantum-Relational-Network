...
rust_blast_asm('ASM-EDGE-SEMANTICS', 38).
rust_blast_asm('ASM-LEAN-TRUST', 30).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 36).
rust_blast_asm('ASM-LAYER-SEMANTICS', 24).
