...
rust_blast_asm('ASM-LEAN-TRUST', 49).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 57).
rust_blast_asm('ASM-LAYER-SEMANTICS', 42).
rust_blast_asm('ASM-EXACT-INTEGER', 3).
