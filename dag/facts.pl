...
rust_closure('QRN-C0-001', 30).
rust_depth('QRN-C0-002', 0).
rust_closure('QRN-C0-002', 29).
...
rust_closure('QRN-GRAV-013', 7).
rust_depth('QRN-GRAV-014', 7).
rust_closure('QRN-GRAV-014', 6).
rust_depth('QRN-GRAV-015', 8).
rust_closure('QRN-GRAV-015', 5).
rust_depth('QRN-GRAV-016', 9).
rust_closure('QRN-GRAV-016', 4).
rust_depth('QRN-GRAV-017', 10).
rust_closure('QRN-GRAV-017', 3).
...
rust_closure('QRN-GRAV-018', 1).
rust_depth('QRN-GRAV-019', 12).
rust_closure('QRN-GRAV-019', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 118).
rust_blast_asm('ASM-GAUSS', 55).
rust_blast_asm('ASM-LOWDIM', 58).
...
rust_blast_fal('FAL-SUITE', 159).
rust_blast_fal('FAL-CEX-WINDOW', 38).
rust_blast_fal('FAL-QNEC', 14).
rust_blast_fal('FAL-CONTINUUM', 76).
