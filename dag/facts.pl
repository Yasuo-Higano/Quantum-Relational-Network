...
rust_closure('QRN-BRIDGE-029', 1).
rust_depth('QRN-BRIDGE-030', 10).
rust_closure('QRN-BRIDGE-030', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 176).
rust_blast_asm('ASM-GAUSS', 95).
rust_blast_asm('ASM-LOWDIM', 94).
...
rust_blast_asm('ASM-EDGE-SEMANTICS', 46).
rust_blast_asm('ASM-LEAN-TRUST', 38).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 45).
rust_blast_asm('ASM-LAYER-SEMANTICS', 32).
