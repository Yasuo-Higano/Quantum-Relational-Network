...
rust_blast_asm('ASM-EDGE-SEMANTICS', 18).
rust_blast_asm('ASM-LEAN-TRUST', 10).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 21).
rust_blast_asm('ASM-LAYER-SEMANTICS', 4).
