...
rust_closure('QRN-C0-005', 70).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 54).
...
rust_closure('QRN-MATTER-001', 52).
...
rust_closure('QRN-EXP-001', 33).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 20).
...
rust_closure('QRN-YUK-003', 49).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 31).
...
rust_closure('QRN-YUK-005', 45).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 44).
...
rust_closure('QRN-YUK-022', 22).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 21).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 20).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 14).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 14).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 13).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 12).
rust_depth('QRN-META-017', 18).
rust_closure('QRN-META-017', 1).
rust_depth('QRN-YUK-026', 16).
rust_closure('QRN-YUK-026', 0).
rust_depth('QRN-YUK-027', 15).
rust_closure('QRN-YUK-027', 13).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 11).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 10).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 9).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 9).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 8).
rust_depth('QRN-YUK-030', 21).
rust_closure('QRN-YUK-030', 1).
rust_depth('QRN-META-018', 22).
rust_closure('QRN-META-018', 0).
rust_depth('QRN-YUK-031', 21).
rust_closure('QRN-YUK-031', 0).
rust_depth('QRN-LEP-001', 21).
rust_closure('QRN-LEP-001', 4).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 3).
rust_depth('QRN-LEP-003', 23).
rust_closure('QRN-LEP-003', 2).
rust_depth('QRN-LEP-004', 24).
rust_closure('QRN-LEP-004', 1).
rust_depth('QRN-LEP-005', 25).
rust_closure('QRN-LEP-005', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 86).
rust_blast_asm('ASM-GAUSS', 33).
rust_blast_asm('ASM-LOWDIM', 36).
rust_blast_asm('ASM-WICK', 1).
rust_blast_asm('ASM-ENVARIANCE', 1).
rust_blast_asm('ASM-INIT', 9).
rust_blast_asm('ASM-DOF-GROWTH', 7).
rust_blast_asm('ASM-SIGMA-DATA', 43).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 32).
rust_blast_asm('ASM-DIAGPAIR', 50).
rust_blast_asm('ASM-GAUGE-GROUP', 28).
rust_blast_asm('ASM-CHIRALITY', 26).
rust_blast_asm('ASM-ALL-CHARGED', 26).
rust_blast_asm('ASM-EFT-VALIDITY', 21).
rust_blast_asm('ASM-SMCONTENT', 7).
rust_blast_asm('ASM-TORUS', 54).
rust_blast_asm('ASM-OVERLAP', 51).
rust_blast_asm('ASM-WILSON-GRID', 51).
rust_blast_asm('ASM-WINDOW-V31', 21).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 8).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 27).
rust_blast_asm('ASM-PDG', 59).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 67).
rust_blast_asm('ASM-PRIOR', 54).
rust_blast_asm('ASM-STABLE-LABEL', 50).
rust_blast_asm('ASM-MODK', 16).
rust_blast_asm('ASM-Z2-MINIMAL', 5).
rust_blast_asm('ASM-EDGE-SEMANTICS', 5).
rust_blast_asm('ASM-LEAN-TRUST', 7).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_fal('FAL-BMV', 37).
rust_blast_fal('FAL-PAGE', 5).
rust_blast_fal('FAL-LORENTZ', 4).
rust_blast_fal('FAL-DIMFLOW', 4).
rust_blast_fal('FAL-GLOBALSYM', 3).
rust_blast_fal('FAL-AREALAW', 10).
rust_blast_fal('FAL-EXOTIC-CHIRAL', 21).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 6).
rust_blast_fal('FAL-CKM-OOS', 53).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 126).
rust_blast_fal('FAL-CEX-WINDOW', 32).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 44).
