...
rust_blast_asm('ASM-GAUSS', 96).
rust_blast_asm('ASM-LOWDIM', 95).
...
rust_blast_asm('ASM-EDGE-SEMANTICS', 47).
rust_blast_asm('ASM-LEAN-TRUST', 39).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 46).
rust_blast_asm('ASM-LAYER-SEMANTICS', 33).
