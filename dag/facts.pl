...
rust_closure('QRN-META-038', 10).
rust_depth('QRN-BRIDGE-012', 5).
rust_closure('QRN-BRIDGE-012', 6).
rust_depth('QRN-BRIDGE-013', 5).
rust_closure('QRN-BRIDGE-013', 8).
rust_depth('QRN-BRIDGE-014', 6).
rust_closure('QRN-BRIDGE-014', 4).
...
rust_blast_asm('ASM-GAUSS', 85).
rust_blast_asm('ASM-LOWDIM', 83).
...
rust_blast_asm('ASM-EDGE-SEMANTICS', 34).
rust_blast_asm('ASM-LEAN-TRUST', 26).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 34).
rust_blast_asm('ASM-LAYER-SEMANTICS', 20).
