...
rust_closure('QRN-META-038', 8).
rust_depth('QRN-BRIDGE-012', 5).
rust_closure('QRN-BRIDGE-012', 4).
rust_depth('QRN-BRIDGE-013', 5).
rust_closure('QRN-BRIDGE-013', 6).
rust_depth('QRN-BRIDGE-014', 6).
rust_closure('QRN-BRIDGE-014', 2).
...
rust_blast_asm('ASM-SEED', 84).
rust_blast_asm('ASM-PRIOR', 65).
rust_blast_asm('ASM-STABLE-LABEL', 61).
rust_blast_asm('ASM-MODK', 49).
rust_blast_asm('ASM-Z2-MINIMAL', 27).
rust_blast_asm('ASM-EDGE-SEMANTICS', 32).
rust_blast_asm('ASM-LEAN-TRUST', 24).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 32).
rust_blast_asm('ASM-LAYER-SEMANTICS', 18).
