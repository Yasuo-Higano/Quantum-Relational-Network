...
rust_closure('QRN-C0-005', 66).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 50).
...
rust_closure('QRN-MATTER-001', 48).
...
rust_closure('QRN-EXP-001', 29).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 16).
...
rust_closure('QRN-YUK-003', 45).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 27).
...
rust_closure('QRN-YUK-005', 41).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 40).
...
rust_closure('QRN-YUK-017', 23).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 22).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 21).
...
rust_closure('QRN-YUK-022', 18).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 17).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 16).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 10).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 10).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 9).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 8).
...
rust_closure('QRN-YUK-027', 9).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 7).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 6).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 5).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 5).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 4).
...
rust_closure('QRN-LEP-001', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 82).
...
rust_blast_asm('ASM-SIGMA-DATA', 39).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 28).
rust_blast_asm('ASM-DIAGPAIR', 46).
rust_blast_asm('ASM-GAUGE-GROUP', 24).
rust_blast_asm('ASM-CHIRALITY', 22).
rust_blast_asm('ASM-ALL-CHARGED', 22).
rust_blast_asm('ASM-EFT-VALIDITY', 17).
rust_blast_asm('ASM-SMCONTENT', 3).
rust_blast_asm('ASM-TORUS', 50).
rust_blast_asm('ASM-OVERLAP', 47).
rust_blast_asm('ASM-WILSON-GRID', 47).
rust_blast_asm('ASM-WINDOW-V31', 17).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 4).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 23).
rust_blast_asm('ASM-PDG', 55).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 63).
rust_blast_asm('ASM-PRIOR', 50).
rust_blast_asm('ASM-STABLE-LABEL', 46).
...
rust_blast_fal('FAL-EXOTIC-CHIRAL', 17).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 2).
rust_blast_fal('FAL-CKM-OOS', 49).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 122).
rust_blast_fal('FAL-CEX-WINDOW', 28).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 40).
