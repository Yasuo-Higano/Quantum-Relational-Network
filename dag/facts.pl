...
rust_closure('QRN-GRAV-051', 2).
rust_depth('QRN-GRAV-052', 3).
rust_closure('QRN-GRAV-052', 1).
rust_depth('QRN-GRAV-053', 4).
rust_closure('QRN-GRAV-053', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 153).
