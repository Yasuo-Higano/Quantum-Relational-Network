...
rust_closure('QRN-C0-005', 68).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 52).
...
rust_closure('QRN-MATTER-001', 50).
...
rust_closure('QRN-EXP-001', 31).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 18).
...
rust_closure('QRN-YUK-003', 47).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 29).
...
rust_closure('QRN-YUK-005', 43).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 42).
...
rust_closure('QRN-YUK-017', 25).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 24).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 23).
...
rust_closure('QRN-YUK-022', 20).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 19).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 18).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 12).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 12).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 11).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 10).
...
rust_closure('QRN-YUK-027', 11).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 9).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 8).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 7).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 7).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 6).
...
rust_closure('QRN-LEP-001', 2).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 1).
rust_depth('QRN-LEP-003', 23).
rust_closure('QRN-LEP-003', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 84).
...
rust_blast_asm('ASM-SIGMA-DATA', 41).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 30).
rust_blast_asm('ASM-DIAGPAIR', 48).
rust_blast_asm('ASM-GAUGE-GROUP', 26).
rust_blast_asm('ASM-CHIRALITY', 24).
rust_blast_asm('ASM-ALL-CHARGED', 24).
rust_blast_asm('ASM-EFT-VALIDITY', 19).
rust_blast_asm('ASM-SMCONTENT', 5).
rust_blast_asm('ASM-TORUS', 52).
rust_blast_asm('ASM-OVERLAP', 49).
rust_blast_asm('ASM-WILSON-GRID', 49).
rust_blast_asm('ASM-WINDOW-V31', 19).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 6).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 25).
rust_blast_asm('ASM-PDG', 57).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 65).
rust_blast_asm('ASM-PRIOR', 52).
rust_blast_asm('ASM-STABLE-LABEL', 48).
...
rust_blast_fal('FAL-EXOTIC-CHIRAL', 19).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 4).
rust_blast_fal('FAL-CKM-OOS', 51).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 124).
rust_blast_fal('FAL-CEX-WINDOW', 30).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 42).
