...
rust_closure('QRN-GRAV-051', 1).
rust_depth('QRN-GRAV-052', 3).
rust_closure('QRN-GRAV-052', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 152).
