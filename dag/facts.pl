...
rust_blast_asm('ASM-EDGE-SEMANTICS', 25).
rust_blast_asm('ASM-LEAN-TRUST', 17).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 25).
rust_blast_asm('ASM-LAYER-SEMANTICS', 11).
