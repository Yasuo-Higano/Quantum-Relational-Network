...
rust_closure('QRN-CAUSAL-001', 18).
rust_depth('QRN-CAUSAL-002', 1).
rust_closure('QRN-CAUSAL-002', 15).
rust_depth('QRN-ER-001', 0).
rust_closure('QRN-ER-001', 11).
...
rust_blast_asm('ASM-Z2-MINIMAL', 20).
...
rust_blast_fal('FAL-SUITE', 217).
rust_blast_fal('FAL-CEX-WINDOW', 41).
rust_blast_fal('FAL-QNEC', 17).
rust_blast_fal('FAL-CONTINUUM', 95).
