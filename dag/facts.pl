...
rust_blast_asm('ASM-EDGE-SEMANTICS', 23).
rust_blast_asm('ASM-LEAN-TRUST', 15).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 24).
rust_blast_asm('ASM-LAYER-SEMANTICS', 9).
