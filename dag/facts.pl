...
rust_blast_asm('ASM-LATTICE', 51).
rust_blast_asm('ASM-GAUSS', 27).
rust_blast_asm('ASM-LOWDIM', 30).
...
rust_blast_fal('FAL-SUITE', 91).
rust_blast_fal('FAL-CEX-WINDOW', 26).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 18).
