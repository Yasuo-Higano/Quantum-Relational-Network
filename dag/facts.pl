...
rust_closure('QRN-C0-001', 33).
rust_depth('QRN-C0-002', 0).
rust_closure('QRN-C0-002', 32).
...
rust_closure('QRN-GRAV-013', 10).
rust_depth('QRN-GRAV-014', 7).
rust_closure('QRN-GRAV-014', 9).
rust_depth('QRN-GRAV-015', 8).
rust_closure('QRN-GRAV-015', 8).
rust_depth('QRN-GRAV-016', 9).
rust_closure('QRN-GRAV-016', 7).
rust_depth('QRN-GRAV-017', 10).
rust_closure('QRN-GRAV-017', 6).
...
rust_closure('QRN-GRAV-018', 4).
rust_depth('QRN-GRAV-019', 12).
rust_closure('QRN-GRAV-019', 3).
rust_depth('QRN-GRAV-020', 13).
rust_closure('QRN-GRAV-020', 2).
rust_depth('QRN-GRAV-021', 14).
rust_closure('QRN-GRAV-021', 1).
rust_depth('QRN-GRAV-022', 15).
rust_closure('QRN-GRAV-022', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 121).
rust_blast_asm('ASM-GAUSS', 58).
rust_blast_asm('ASM-LOWDIM', 61).
...
rust_blast_fal('FAL-SUITE', 162).
rust_blast_fal('FAL-CEX-WINDOW', 38).
rust_blast_fal('FAL-QNEC', 14).
rust_blast_fal('FAL-CONTINUUM', 79).
