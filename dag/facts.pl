...
rust_closure('QRN-META-038', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 175).
rust_blast_asm('ASM-GAUSS', 75).
...
rust_blast_asm('ASM-EDGE-SEMANTICS', 24).
rust_blast_asm('ASM-LEAN-TRUST', 16).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 24).
rust_blast_asm('ASM-LAYER-SEMANTICS', 10).
