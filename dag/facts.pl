...
rust_closure('QRN-BRIDGE-021', 3).
rust_depth('QRN-META-040', 5).
rust_closure('QRN-META-040', 1).
rust_depth('QRN-BRIDGE-022', 7).
rust_closure('QRN-BRIDGE-022', 13).
rust_depth('QRN-META-041', 3).
rust_closure('QRN-META-041', 1).
rust_depth('QRN-BRIDGE-023', 8).
rust_closure('QRN-BRIDGE-023', 11).
rust_depth('QRN-BRIDGE-024', 8).
rust_closure('QRN-BRIDGE-024', 11).
rust_depth('QRN-BRIDGE-025', 9).
rust_closure('QRN-BRIDGE-025', 3).
rust_depth('QRN-BRIDGE-026', 0).
rust_closure('QRN-BRIDGE-026', 0).
rust_depth('QRN-BRIDGE-027', 10).
rust_closure('QRN-BRIDGE-027', 2).
rust_depth('QRN-BRIDGE-028', 11).
rust_closure('QRN-BRIDGE-028', 1).
rust_depth('QRN-META-042', 12).
rust_closure('QRN-META-042', 0).
rust_depth('QRN-BRIDGE-029', 9).
rust_closure('QRN-BRIDGE-029', 6).
rust_depth('QRN-BRIDGE-030', 10).
rust_closure('QRN-BRIDGE-030', 2).
rust_depth('QRN-BRIDGE-031', 11).
rust_closure('QRN-BRIDGE-031', 1).
rust_depth('QRN-BRIDGE-032', 10).
rust_closure('QRN-BRIDGE-032', 1).
rust_depth('QRN-BRIDGE-033', 10).
rust_closure('QRN-BRIDGE-033', 1).
rust_depth('QRN-BRIDGE-034', 10).
rust_closure('QRN-BRIDGE-034', 1).
rust_depth('QRN-BRIDGE-035', 12).
rust_closure('QRN-BRIDGE-035', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 176).
rust_blast_asm('ASM-GAUSS', 100).
rust_blast_asm('ASM-LOWDIM', 99).
...
rust_blast_asm('ASM-SEED', 90).
rust_blast_asm('ASM-PRIOR', 65).
rust_blast_asm('ASM-STABLE-LABEL', 61).
rust_blast_asm('ASM-MODK', 49).
rust_blast_asm('ASM-Z2-MINIMAL', 27).
rust_blast_asm('ASM-EDGE-SEMANTICS', 51).
rust_blast_asm('ASM-LEAN-TRUST', 43).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 50).
rust_blast_asm('ASM-LAYER-SEMANTICS', 37).
