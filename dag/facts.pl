...
rust_closure('QRN-GRAV-043', 11).
rust_depth('QRN-GRAV-044', 2).
rust_closure('QRN-GRAV-044', 7).
...
rust_closure('QRN-GRAV-051', 3).
rust_depth('QRN-GRAV-052', 3).
rust_closure('QRN-GRAV-052', 2).
rust_depth('QRN-GRAV-053', 4).
rust_closure('QRN-GRAV-053', 1).
rust_depth('QRN-GRAV-054', 5).
rust_closure('QRN-GRAV-054', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 154).
