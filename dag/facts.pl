...
rust_closure('QRN-C0-001', 32).
rust_depth('QRN-C0-002', 0).
rust_closure('QRN-C0-002', 31).
...
rust_closure('QRN-GRAV-013', 9).
rust_depth('QRN-GRAV-014', 7).
rust_closure('QRN-GRAV-014', 8).
rust_depth('QRN-GRAV-015', 8).
rust_closure('QRN-GRAV-015', 7).
rust_depth('QRN-GRAV-016', 9).
rust_closure('QRN-GRAV-016', 6).
rust_depth('QRN-GRAV-017', 10).
rust_closure('QRN-GRAV-017', 5).
...
rust_closure('QRN-GRAV-018', 3).
rust_depth('QRN-GRAV-019', 12).
rust_closure('QRN-GRAV-019', 2).
rust_depth('QRN-GRAV-020', 13).
rust_closure('QRN-GRAV-020', 1).
rust_depth('QRN-GRAV-021', 14).
rust_closure('QRN-GRAV-021', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 120).
rust_blast_asm('ASM-GAUSS', 57).
rust_blast_asm('ASM-LOWDIM', 60).
...
rust_blast_fal('FAL-SUITE', 161).
rust_blast_fal('FAL-CEX-WINDOW', 38).
rust_blast_fal('FAL-QNEC', 14).
rust_blast_fal('FAL-CONTINUUM', 78).
