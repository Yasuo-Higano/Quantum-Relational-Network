...
rust_closure('QRN-GEOM-003', 21).
rust_depth('QRN-GRAV-001', 1).
rust_closure('QRN-GRAV-001', 29).
...
rust_closure('QRN-MATTER-001', 59).
...
rust_closure('QRN-EXP-001', 40).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 27).
...
rust_closure('QRN-YUK-003', 56).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 38).
...
rust_closure('QRN-YUK-005', 52).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 51).
...
rust_closure('QRN-META-015', 11).
rust_depth('QRN-TOOL-002', 1).
rust_closure('QRN-TOOL-002', 10).
rust_depth('QRN-CORE-005', 1).
rust_closure('QRN-CORE-005', 10).
rust_depth('QRN-CONT-001', 1).
rust_closure('QRN-CONT-001', 10).
rust_depth('QRN-SEL-001', 8).
rust_closure('QRN-SEL-001', 10).
rust_depth('QRN-GRAV-004', 1).
rust_closure('QRN-GRAV-004', 10).
rust_depth('QRN-PRED-001', 8).
rust_closure('QRN-PRED-001', 36).
rust_depth('QRN-META-016', 9).
rust_closure('QRN-META-016', 9).
rust_depth('QRN-YUK-016', 11).
rust_closure('QRN-YUK-016', 0).
rust_depth('QRN-YUK-017', 9).
rust_closure('QRN-YUK-017', 34).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 33).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 32).
...
rust_closure('QRN-YUK-022', 29).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 28).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 27).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 21).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 21).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 20).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 19).
rust_depth('QRN-META-017', 18).
rust_closure('QRN-META-017', 8).
rust_depth('QRN-YUK-026', 16).
rust_closure('QRN-YUK-026', 0).
rust_depth('QRN-YUK-027', 15).
rust_closure('QRN-YUK-027', 20).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 18).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 17).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 16).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 16).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 15).
rust_depth('QRN-YUK-030', 21).
rust_closure('QRN-YUK-030', 8).
rust_depth('QRN-META-018', 22).
rust_closure('QRN-META-018', 7).
rust_depth('QRN-YUK-031', 21).
rust_closure('QRN-YUK-031', 7).
rust_depth('QRN-LEP-001', 21).
rust_closure('QRN-LEP-001', 11).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 10).
rust_depth('QRN-LEP-003', 23).
rust_closure('QRN-LEP-003', 9).
rust_depth('QRN-LEP-004', 24).
rust_closure('QRN-LEP-004', 8).
rust_depth('QRN-LEP-005', 25).
rust_closure('QRN-LEP-005', 7).
rust_depth('QRN-META-019', 26).
rust_closure('QRN-META-019', 6).
rust_depth('QRN-GRAV-005', 2).
rust_closure('QRN-GRAV-005', 25).
rust_depth('QRN-GRAV-006', 3).
rust_closure('QRN-GRAV-006', 19).
rust_depth('QRN-GRAV-007', 3).
rust_closure('QRN-GRAV-007', 7).
rust_depth('QRN-GRAV-008', 4).
rust_closure('QRN-GRAV-008', 18).
rust_depth('QRN-GRAV-009', 3).
rust_closure('QRN-GRAV-009', 6).
rust_depth('QRN-GRAV-010', 5).
rust_closure('QRN-GRAV-010', 17).
rust_depth('QRN-GRAV-011', 4).
rust_closure('QRN-GRAV-011', 6).
rust_depth('QRN-META-020', 27).
rust_closure('QRN-META-020', 5).
rust_depth('QRN-CORE-006', 0).
rust_closure('QRN-CORE-006', 14).
rust_depth('QRN-CORE-007', 1).
rust_closure('QRN-CORE-007', 5).
rust_depth('QRN-CORE-008', 1).
rust_closure('QRN-CORE-008', 5).
rust_depth('QRN-CORE-009', 1).
rust_closure('QRN-CORE-009', 5).
rust_depth('QRN-CORE-010', 1).
rust_closure('QRN-CORE-010', 7).
rust_depth('QRN-CORE-011', 2).
rust_closure('QRN-CORE-011', 6).
rust_depth('QRN-META-021', 28).
rust_closure('QRN-META-021', 4).
...
rust_closure('QRN-META-022', 3).
rust_depth('QRN-META-023', 30).
rust_closure('QRN-META-023', 2).
rust_depth('QRN-CORE-014', 3).
rust_closure('QRN-CORE-014', 2).
rust_depth('QRN-GRAV-013', 6).
rust_closure('QRN-GRAV-013', 12).
rust_depth('QRN-GRAV-014', 7).
rust_closure('QRN-GRAV-014', 11).
rust_depth('QRN-GRAV-015', 8).
rust_closure('QRN-GRAV-015', 10).
rust_depth('QRN-GRAV-016', 9).
rust_closure('QRN-GRAV-016', 9).
rust_depth('QRN-GRAV-017', 10).
rust_closure('QRN-GRAV-017', 8).
rust_depth('QRN-GAUGE-019', 2).
rust_closure('QRN-GAUGE-019', 2).
rust_depth('QRN-META-024', 31).
rust_closure('QRN-META-024', 1).
rust_depth('QRN-GRAV-018', 11).
rust_closure('QRN-GRAV-018', 6).
rust_depth('QRN-GRAV-019', 12).
rust_closure('QRN-GRAV-019', 5).
rust_depth('QRN-GRAV-020', 13).
rust_closure('QRN-GRAV-020', 4).
rust_depth('QRN-GRAV-021', 14).
rust_closure('QRN-GRAV-021', 3).
rust_depth('QRN-GRAV-022', 15).
rust_closure('QRN-GRAV-022', 2).
rust_depth('QRN-GRAV-023', 16).
rust_closure('QRN-GRAV-023', 1).
rust_depth('QRN-META-025', 32).
rust_closure('QRN-META-025', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 123).
rust_blast_asm('ASM-GAUSS', 60).
rust_blast_asm('ASM-LOWDIM', 63).
rust_blast_asm('ASM-WICK', 1).
rust_blast_asm('ASM-ENVARIANCE', 1).
rust_blast_asm('ASM-INIT', 9).
rust_blast_asm('ASM-DOF-GROWTH', 7).
rust_blast_asm('ASM-SIGMA-DATA', 51).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 39).
rust_blast_asm('ASM-DIAGPAIR', 57).
rust_blast_asm('ASM-GAUGE-GROUP', 35).
rust_blast_asm('ASM-CHIRALITY', 33).
rust_blast_asm('ASM-ALL-CHARGED', 33).
rust_blast_asm('ASM-EFT-VALIDITY', 28).
rust_blast_asm('ASM-SMCONTENT', 14).
rust_blast_asm('ASM-TORUS', 62).
rust_blast_asm('ASM-OVERLAP', 59).
rust_blast_asm('ASM-WILSON-GRID', 59).
rust_blast_asm('ASM-WINDOW-V31', 28).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 15).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 34).
rust_blast_asm('ASM-PDG', 67).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 74).
rust_blast_asm('ASM-PRIOR', 62).
rust_blast_asm('ASM-STABLE-LABEL', 58).
rust_blast_asm('ASM-MODK', 43).
rust_blast_asm('ASM-Z2-MINIMAL', 12).
rust_blast_asm('ASM-EDGE-SEMANTICS', 12).
rust_blast_asm('ASM-LEAN-TRUST', 8).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_fal('FAL-BMV', 45).
rust_blast_fal('FAL-PAGE', 5).
rust_blast_fal('FAL-LORENTZ', 5).
rust_blast_fal('FAL-DIMFLOW', 4).
rust_blast_fal('FAL-GLOBALSYM', 3).
rust_blast_fal('FAL-AREALAW', 37).
rust_blast_fal('FAL-EXOTIC-CHIRAL', 28).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 13).
rust_blast_fal('FAL-CKM-OOS', 60).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 164).
rust_blast_fal('FAL-CEX-WINDOW', 39).
rust_blast_fal('FAL-QNEC', 15).
rust_blast_fal('FAL-CONTINUUM', 81).
