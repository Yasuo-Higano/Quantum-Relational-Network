...
rust_closure('QRN-GEOM-003', 15).
rust_depth('QRN-GRAV-001', 1).
rust_closure('QRN-GRAV-001', 10).
...
rust_closure('QRN-MATTER-001', 53).
...
rust_closure('QRN-EXP-001', 34).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 21).
...
rust_closure('QRN-YUK-003', 50).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 32).
...
rust_closure('QRN-YUK-005', 46).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 45).
...
rust_closure('QRN-YUK-022', 23).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 22).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 21).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 15).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 15).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 14).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 13).
rust_depth('QRN-META-017', 18).
rust_closure('QRN-META-017', 2).
rust_depth('QRN-YUK-026', 16).
rust_closure('QRN-YUK-026', 0).
rust_depth('QRN-YUK-027', 15).
rust_closure('QRN-YUK-027', 14).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 12).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 11).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 10).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 10).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 9).
rust_depth('QRN-YUK-030', 21).
rust_closure('QRN-YUK-030', 2).
rust_depth('QRN-META-018', 22).
rust_closure('QRN-META-018', 1).
rust_depth('QRN-YUK-031', 21).
rust_closure('QRN-YUK-031', 1).
rust_depth('QRN-LEP-001', 21).
rust_closure('QRN-LEP-001', 5).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 4).
rust_depth('QRN-LEP-003', 23).
rust_closure('QRN-LEP-003', 3).
rust_depth('QRN-LEP-004', 24).
rust_closure('QRN-LEP-004', 2).
rust_depth('QRN-LEP-005', 25).
rust_closure('QRN-LEP-005', 1).
rust_depth('QRN-META-019', 26).
rust_closure('QRN-META-019', 0).
rust_depth('QRN-GRAV-005', 2).
rust_closure('QRN-GRAV-005', 6).
rust_depth('QRN-GRAV-006', 3).
rust_closure('QRN-GRAV-006', 2).
rust_depth('QRN-GRAV-007', 3).
rust_closure('QRN-GRAV-007', 1).
rust_depth('QRN-GRAV-008', 4).
rust_closure('QRN-GRAV-008', 1).
rust_depth('QRN-GRAV-009', 3).
rust_closure('QRN-GRAV-009', 0).
rust_depth('QRN-GRAV-010', 5).
rust_closure('QRN-GRAV-010', 0).
rust_depth('QRN-GRAV-011', 4).
rust_closure('QRN-GRAV-011', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 94).
rust_blast_asm('ASM-GAUSS', 41).
rust_blast_asm('ASM-LOWDIM', 44).
rust_blast_asm('ASM-WICK', 1).
rust_blast_asm('ASM-ENVARIANCE', 1).
rust_blast_asm('ASM-INIT', 9).
rust_blast_asm('ASM-DOF-GROWTH', 7).
rust_blast_asm('ASM-SIGMA-DATA', 44).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 33).
rust_blast_asm('ASM-DIAGPAIR', 51).
rust_blast_asm('ASM-GAUGE-GROUP', 29).
rust_blast_asm('ASM-CHIRALITY', 27).
rust_blast_asm('ASM-ALL-CHARGED', 27).
rust_blast_asm('ASM-EFT-VALIDITY', 22).
rust_blast_asm('ASM-SMCONTENT', 8).
rust_blast_asm('ASM-TORUS', 55).
rust_blast_asm('ASM-OVERLAP', 52).
rust_blast_asm('ASM-WILSON-GRID', 52).
rust_blast_asm('ASM-WINDOW-V31', 22).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 9).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 28).
rust_blast_asm('ASM-PDG', 60).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 68).
rust_blast_asm('ASM-PRIOR', 55).
rust_blast_asm('ASM-STABLE-LABEL', 51).
rust_blast_asm('ASM-MODK', 24).
rust_blast_asm('ASM-Z2-MINIMAL', 6).
rust_blast_asm('ASM-EDGE-SEMANTICS', 6).
rust_blast_asm('ASM-LEAN-TRUST', 7).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_fal('FAL-BMV', 38).
rust_blast_fal('FAL-PAGE', 5).
rust_blast_fal('FAL-LORENTZ', 4).
rust_blast_fal('FAL-DIMFLOW', 4).
rust_blast_fal('FAL-GLOBALSYM', 3).
rust_blast_fal('FAL-AREALAW', 18).
rust_blast_fal('FAL-EXOTIC-CHIRAL', 22).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 7).
rust_blast_fal('FAL-CKM-OOS', 54).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 134).
rust_blast_fal('FAL-CEX-WINDOW', 33).
rust_blast_fal('FAL-QNEC', 9).
rust_blast_fal('FAL-CONTINUUM', 52).
