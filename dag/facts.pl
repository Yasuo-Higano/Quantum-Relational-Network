...
rust_closure('QRN-C0-005', 61).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 45).
...
rust_closure('QRN-MATTER-001', 43).
...
rust_closure('QRN-YUK-003', 40).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 22).
...
rust_closure('QRN-YUK-005', 36).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 35).
...
rust_closure('QRN-YUK-017', 18).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 17).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 16).
...
rust_closure('QRN-YUK-022', 13).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 12).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 11).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 5).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 5).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 4).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 3).
...
rust_closure('QRN-YUK-027', 4).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 2).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 1).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 0).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 77).
...
rust_blast_asm('ASM-SIGMA-DATA', 34).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 23).
rust_blast_asm('ASM-DIAGPAIR', 41).
...
rust_blast_asm('ASM-TORUS', 45).
rust_blast_asm('ASM-OVERLAP', 42).
rust_blast_asm('ASM-WILSON-GRID', 42).
...
rust_blast_asm('ASM-PDG', 50).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 58).
rust_blast_asm('ASM-PRIOR', 45).
rust_blast_asm('ASM-STABLE-LABEL', 41).
...
rust_blast_fal('FAL-CKM-OOS', 44).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 117).
rust_blast_fal('FAL-CEX-WINDOW', 27).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 35).
