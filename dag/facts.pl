...
rust_closure('QRN-C0-005', 63).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 47).
...
rust_closure('QRN-MATTER-001', 45).
...
rust_closure('QRN-YUK-003', 42).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 24).
...
rust_closure('QRN-YUK-005', 38).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 37).
...
rust_blast_asm('ASM-TORUS', 47).
rust_blast_asm('ASM-OVERLAP', 44).
rust_blast_asm('ASM-WILSON-GRID', 44).
