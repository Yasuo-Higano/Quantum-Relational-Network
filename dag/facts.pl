...
rust_blast_asm('ASM-EDGE-SEMANTICS', 27).
rust_blast_asm('ASM-LEAN-TRUST', 19).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 27).
rust_blast_asm('ASM-LAYER-SEMANTICS', 13).
