...
rust_closure('QRN-META-038', 2).
rust_depth('QRN-BRIDGE-012', 5).
rust_closure('QRN-BRIDGE-012', 0).
rust_depth('QRN-BRIDGE-013', 5).
rust_closure('QRN-BRIDGE-013', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 175).
rust_blast_asm('ASM-GAUSS', 77).
...
rust_blast_asm('ASM-EDGE-SEMANTICS', 26).
rust_blast_asm('ASM-LEAN-TRUST', 18).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 26).
rust_blast_asm('ASM-LAYER-SEMANTICS', 12).
