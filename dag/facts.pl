...
rust_closure('QRN-CAUSAL-001', 22).
rust_depth('QRN-CAUSAL-002', 1).
rust_closure('QRN-CAUSAL-002', 19).
rust_depth('QRN-ER-001', 0).
rust_closure('QRN-ER-001', 15).
...
rust_closure('QRN-BRIDGE-001', 10).
rust_depth('QRN-BRIDGE-002', 6).
rust_closure('QRN-BRIDGE-002', 9).
rust_depth('QRN-BRIDGE-003', 7).
rust_closure('QRN-BRIDGE-003', 8).
rust_depth('QRN-META-035', 14).
rust_closure('QRN-META-035', 1).
rust_depth('QRN-BRIDGE-004', 8).
rust_closure('QRN-BRIDGE-004', 6).
rust_depth('QRN-META-036', 15).
rust_closure('QRN-META-036', 0).
rust_depth('QRN-BRIDGE-005', 9).
rust_closure('QRN-BRIDGE-005', 4).
rust_depth('QRN-BRIDGE-006', 10).
rust_closure('QRN-BRIDGE-006', 3).
rust_depth('QRN-BRIDGE-007', 11).
rust_closure('QRN-BRIDGE-007', 2).
rust_depth('QRN-BRIDGE-008', 12).
rust_closure('QRN-BRIDGE-008', 1).
rust_depth('QRN-BRIDGE-009', 13).
rust_closure('QRN-BRIDGE-009', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 173).
rust_blast_asm('ASM-GAUSS', 73).
rust_blast_asm('ASM-LOWDIM', 76).
rust_blast_asm('ASM-WICK', 1).
rust_blast_asm('ASM-ENVARIANCE', 1).
rust_blast_asm('ASM-INIT', 20).
rust_blast_asm('ASM-DOF-GROWTH', 18).
...
rust_blast_asm('ASM-SEED', 80).
rust_blast_asm('ASM-PRIOR', 65).
rust_blast_asm('ASM-STABLE-LABEL', 61).
rust_blast_asm('ASM-MODK', 49).
rust_blast_asm('ASM-Z2-MINIMAL', 24).
rust_blast_asm('ASM-EDGE-SEMANTICS', 22).
rust_blast_asm('ASM-LEAN-TRUST', 14).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 24).
rust_blast_asm('ASM-LAYER-SEMANTICS', 8).
...
rust_blast_fal('FAL-SUITE', 221).
rust_blast_fal('FAL-CEX-WINDOW', 41).
rust_blast_fal('FAL-QNEC', 17).
rust_blast_fal('FAL-CONTINUUM', 99).
