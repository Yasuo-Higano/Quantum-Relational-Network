...
rust_closure('QRN-C0-005', 60).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 44).
...
rust_closure('QRN-MATTER-001', 42).
...
rust_closure('QRN-YUK-003', 39).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 21).
...
rust_closure('QRN-YUK-005', 35).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 34).
...
rust_closure('QRN-YUK-017', 17).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 16).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 15).
...
rust_closure('QRN-YUK-022', 12).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 11).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 10).
...
rust_blast_asm('ASM-SIGMA-DATA', 33).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 22).
rust_blast_asm('ASM-DIAGPAIR', 40).
...
rust_blast_asm('ASM-TORUS', 44).
rust_blast_asm('ASM-OVERLAP', 41).
rust_blast_asm('ASM-WILSON-GRID', 41).
...
rust_blast_asm('ASM-PDG', 49).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 57).
rust_blast_asm('ASM-PRIOR', 44).
rust_blast_asm('ASM-STABLE-LABEL', 40).
...
rust_blast_fal('FAL-CKM-OOS', 43).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 116).
rust_blast_fal('FAL-CEX-WINDOW', 27).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 34).
