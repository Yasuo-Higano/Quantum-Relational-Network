...
rust_closure('QRN-GEOM-003', 19).
rust_depth('QRN-GRAV-001', 1).
rust_closure('QRN-GRAV-001', 21).
...
rust_closure('QRN-MATTER-001', 57).
...
rust_closure('QRN-EXP-001', 38).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 25).
...
rust_closure('QRN-YUK-003', 54).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 36).
...
rust_closure('QRN-YUK-005', 50).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 49).
...
rust_closure('QRN-YUK-022', 27).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 26).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 25).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 19).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 19).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 18).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 17).
rust_depth('QRN-META-017', 18).
rust_closure('QRN-META-017', 6).
rust_depth('QRN-YUK-026', 16).
rust_closure('QRN-YUK-026', 0).
rust_depth('QRN-YUK-027', 15).
rust_closure('QRN-YUK-027', 18).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 16).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 15).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 14).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 14).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 13).
rust_depth('QRN-YUK-030', 21).
rust_closure('QRN-YUK-030', 6).
rust_depth('QRN-META-018', 22).
rust_closure('QRN-META-018', 5).
rust_depth('QRN-YUK-031', 21).
rust_closure('QRN-YUK-031', 5).
rust_depth('QRN-LEP-001', 21).
rust_closure('QRN-LEP-001', 9).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 8).
rust_depth('QRN-LEP-003', 23).
rust_closure('QRN-LEP-003', 7).
rust_depth('QRN-LEP-004', 24).
rust_closure('QRN-LEP-004', 6).
rust_depth('QRN-LEP-005', 25).
rust_closure('QRN-LEP-005', 5).
rust_depth('QRN-META-019', 26).
rust_closure('QRN-META-019', 4).
rust_depth('QRN-GRAV-005', 2).
rust_closure('QRN-GRAV-005', 17).
rust_depth('QRN-GRAV-006', 3).
rust_closure('QRN-GRAV-006', 11).
rust_depth('QRN-GRAV-007', 3).
rust_closure('QRN-GRAV-007', 5).
rust_depth('QRN-GRAV-008', 4).
rust_closure('QRN-GRAV-008', 10).
rust_depth('QRN-GRAV-009', 3).
rust_closure('QRN-GRAV-009', 4).
rust_depth('QRN-GRAV-010', 5).
rust_closure('QRN-GRAV-010', 9).
rust_depth('QRN-GRAV-011', 4).
rust_closure('QRN-GRAV-011', 4).
rust_depth('QRN-META-020', 27).
rust_closure('QRN-META-020', 3).
rust_depth('QRN-CORE-006', 0).
rust_closure('QRN-CORE-006', 12).
rust_depth('QRN-CORE-007', 1).
rust_closure('QRN-CORE-007', 3).
rust_depth('QRN-CORE-008', 1).
rust_closure('QRN-CORE-008', 3).
rust_depth('QRN-CORE-009', 1).
rust_closure('QRN-CORE-009', 3).
rust_depth('QRN-CORE-010', 1).
rust_closure('QRN-CORE-010', 5).
rust_depth('QRN-CORE-011', 2).
rust_closure('QRN-CORE-011', 4).
rust_depth('QRN-META-021', 28).
rust_closure('QRN-META-021', 2).
...
rust_closure('QRN-META-022', 1).
rust_depth('QRN-META-023', 30).
rust_closure('QRN-META-023', 0).
rust_depth('QRN-CORE-014', 3).
rust_closure('QRN-CORE-014', 0).
rust_depth('QRN-GRAV-013', 6).
rust_closure('QRN-GRAV-013', 4).
rust_depth('QRN-GRAV-014', 7).
rust_closure('QRN-GRAV-014', 3).
rust_depth('QRN-GRAV-015', 8).
rust_closure('QRN-GRAV-015', 2).
rust_depth('QRN-GRAV-016', 9).
rust_closure('QRN-GRAV-016', 1).
rust_depth('QRN-GRAV-017', 10).
rust_closure('QRN-GRAV-017', 0).
rust_depth('QRN-GAUGE-019', 2).
rust_closure('QRN-GAUGE-019', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 115).
rust_blast_asm('ASM-GAUSS', 52).
rust_blast_asm('ASM-LOWDIM', 55).
rust_blast_asm('ASM-WICK', 1).
rust_blast_asm('ASM-ENVARIANCE', 1).
rust_blast_asm('ASM-INIT', 9).
rust_blast_asm('ASM-DOF-GROWTH', 7).
rust_blast_asm('ASM-SIGMA-DATA', 49).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 37).
rust_blast_asm('ASM-DIAGPAIR', 55).
rust_blast_asm('ASM-GAUGE-GROUP', 33).
rust_blast_asm('ASM-CHIRALITY', 31).
rust_blast_asm('ASM-ALL-CHARGED', 31).
rust_blast_asm('ASM-EFT-VALIDITY', 26).
rust_blast_asm('ASM-SMCONTENT', 12).
rust_blast_asm('ASM-TORUS', 60).
rust_blast_asm('ASM-OVERLAP', 57).
rust_blast_asm('ASM-WILSON-GRID', 57).
rust_blast_asm('ASM-WINDOW-V31', 26).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 13).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 32).
rust_blast_asm('ASM-PDG', 65).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 72).
rust_blast_asm('ASM-PRIOR', 60).
rust_blast_asm('ASM-STABLE-LABEL', 56).
rust_blast_asm('ASM-MODK', 35).
rust_blast_asm('ASM-Z2-MINIMAL', 10).
rust_blast_asm('ASM-EDGE-SEMANTICS', 10).
rust_blast_asm('ASM-LEAN-TRUST', 8).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_fal('FAL-BMV', 43).
rust_blast_fal('FAL-PAGE', 5).
rust_blast_fal('FAL-LORENTZ', 5).
rust_blast_fal('FAL-DIMFLOW', 4).
rust_blast_fal('FAL-GLOBALSYM', 3).
rust_blast_fal('FAL-AREALAW', 29).
rust_blast_fal('FAL-EXOTIC-CHIRAL', 26).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 11).
rust_blast_fal('FAL-CKM-OOS', 58).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 156).
rust_blast_fal('FAL-CEX-WINDOW', 37).
rust_blast_fal('FAL-QNEC', 13).
rust_blast_fal('FAL-CONTINUUM', 73).
