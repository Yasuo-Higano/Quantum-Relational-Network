...
rust_closure('QRN-GRAV-043', 2).
rust_depth('QRN-GRAV-044', 2).
rust_closure('QRN-GRAV-044', 1).
rust_depth('QRN-GRAV-045', 3).
rust_closure('QRN-GRAV-045', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 145).
