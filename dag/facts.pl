...
rust_closure('QRN-GEOM-003', 22).
rust_depth('QRN-GRAV-001', 1).
rust_closure('QRN-GRAV-001', 30).
...
rust_closure('QRN-MATTER-001', 60).
...
rust_closure('QRN-EXP-001', 41).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 28).
...
rust_closure('QRN-YUK-003', 57).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 39).
...
rust_closure('QRN-YUK-005', 53).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 52).
...
rust_closure('QRN-META-015', 12).
rust_depth('QRN-TOOL-002', 1).
rust_closure('QRN-TOOL-002', 11).
rust_depth('QRN-CORE-005', 1).
rust_closure('QRN-CORE-005', 11).
rust_depth('QRN-CONT-001', 1).
rust_closure('QRN-CONT-001', 11).
rust_depth('QRN-SEL-001', 8).
rust_closure('QRN-SEL-001', 11).
rust_depth('QRN-GRAV-004', 1).
rust_closure('QRN-GRAV-004', 11).
rust_depth('QRN-PRED-001', 8).
rust_closure('QRN-PRED-001', 37).
rust_depth('QRN-META-016', 9).
rust_closure('QRN-META-016', 10).
rust_depth('QRN-YUK-016', 11).
rust_closure('QRN-YUK-016', 0).
rust_depth('QRN-YUK-017', 9).
rust_closure('QRN-YUK-017', 35).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 34).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 33).
...
rust_closure('QRN-YUK-022', 30).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 29).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 28).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 22).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 22).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 21).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 20).
rust_depth('QRN-META-017', 18).
rust_closure('QRN-META-017', 9).
rust_depth('QRN-YUK-026', 16).
rust_closure('QRN-YUK-026', 0).
rust_depth('QRN-YUK-027', 15).
rust_closure('QRN-YUK-027', 21).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 19).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 18).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 17).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 17).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 16).
rust_depth('QRN-YUK-030', 21).
rust_closure('QRN-YUK-030', 9).
rust_depth('QRN-META-018', 22).
rust_closure('QRN-META-018', 8).
rust_depth('QRN-YUK-031', 21).
rust_closure('QRN-YUK-031', 8).
rust_depth('QRN-LEP-001', 21).
rust_closure('QRN-LEP-001', 12).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 11).
rust_depth('QRN-LEP-003', 23).
rust_closure('QRN-LEP-003', 10).
rust_depth('QRN-LEP-004', 24).
rust_closure('QRN-LEP-004', 9).
rust_depth('QRN-LEP-005', 25).
rust_closure('QRN-LEP-005', 8).
rust_depth('QRN-META-019', 26).
rust_closure('QRN-META-019', 7).
rust_depth('QRN-GRAV-005', 2).
rust_closure('QRN-GRAV-005', 26).
rust_depth('QRN-GRAV-006', 3).
rust_closure('QRN-GRAV-006', 20).
rust_depth('QRN-GRAV-007', 3).
rust_closure('QRN-GRAV-007', 8).
rust_depth('QRN-GRAV-008', 4).
rust_closure('QRN-GRAV-008', 19).
rust_depth('QRN-GRAV-009', 3).
rust_closure('QRN-GRAV-009', 7).
rust_depth('QRN-GRAV-010', 5).
rust_closure('QRN-GRAV-010', 18).
rust_depth('QRN-GRAV-011', 4).
rust_closure('QRN-GRAV-011', 7).
rust_depth('QRN-META-020', 27).
rust_closure('QRN-META-020', 6).
rust_depth('QRN-CORE-006', 0).
rust_closure('QRN-CORE-006', 15).
rust_depth('QRN-CORE-007', 1).
rust_closure('QRN-CORE-007', 6).
rust_depth('QRN-CORE-008', 1).
rust_closure('QRN-CORE-008', 6).
rust_depth('QRN-CORE-009', 1).
rust_closure('QRN-CORE-009', 6).
rust_depth('QRN-CORE-010', 1).
rust_closure('QRN-CORE-010', 8).
rust_depth('QRN-CORE-011', 2).
rust_closure('QRN-CORE-011', 7).
rust_depth('QRN-META-021', 28).
rust_closure('QRN-META-021', 5).
...
rust_closure('QRN-META-022', 4).
rust_depth('QRN-META-023', 30).
rust_closure('QRN-META-023', 3).
rust_depth('QRN-CORE-014', 3).
rust_closure('QRN-CORE-014', 3).
rust_depth('QRN-GRAV-013', 6).
rust_closure('QRN-GRAV-013', 13).
rust_depth('QRN-GRAV-014', 7).
rust_closure('QRN-GRAV-014', 12).
rust_depth('QRN-GRAV-015', 8).
rust_closure('QRN-GRAV-015', 11).
rust_depth('QRN-GRAV-016', 9).
rust_closure('QRN-GRAV-016', 10).
rust_depth('QRN-GRAV-017', 10).
rust_closure('QRN-GRAV-017', 9).
rust_depth('QRN-GAUGE-019', 2).
rust_closure('QRN-GAUGE-019', 3).
rust_depth('QRN-META-024', 31).
rust_closure('QRN-META-024', 2).
rust_depth('QRN-GRAV-018', 11).
rust_closure('QRN-GRAV-018', 7).
rust_depth('QRN-GRAV-019', 12).
rust_closure('QRN-GRAV-019', 6).
rust_depth('QRN-GRAV-020', 13).
rust_closure('QRN-GRAV-020', 5).
rust_depth('QRN-GRAV-021', 14).
rust_closure('QRN-GRAV-021', 4).
rust_depth('QRN-GRAV-022', 15).
rust_closure('QRN-GRAV-022', 3).
rust_depth('QRN-GRAV-023', 16).
rust_closure('QRN-GRAV-023', 2).
rust_depth('QRN-META-025', 32).
rust_closure('QRN-META-025', 1).
rust_depth('QRN-GRAV-024', 0).
rust_closure('QRN-GRAV-024', 8).
rust_depth('QRN-GRAV-025', 1).
rust_closure('QRN-GRAV-025', 7).
rust_depth('QRN-GRAV-026', 2).
rust_closure('QRN-GRAV-026', 5).
rust_depth('QRN-GRAV-027', 3).
rust_closure('QRN-GRAV-027', 4).
rust_depth('QRN-GRAV-028', 2).
rust_closure('QRN-GRAV-028', 1).
rust_depth('QRN-GRAV-029', 4).
rust_closure('QRN-GRAV-029', 1).
rust_depth('QRN-META-026', 33).
rust_closure('QRN-META-026', 0).
rust_depth('QRN-GRAV-030', 4).
rust_closure('QRN-GRAV-030', 1).
rust_depth('QRN-C0-007', 0).
rust_closure('QRN-C0-007', 4).
rust_depth('QRN-GRAV-031', 1).
rust_closure('QRN-GRAV-031', 3).
rust_depth('QRN-GRAV-032', 2).
rust_closure('QRN-GRAV-032', 1).
rust_depth('QRN-GRAV-033', 5).
rust_closure('QRN-GRAV-033', 0).
rust_depth('QRN-GRAV-034', 2).
rust_closure('QRN-GRAV-034', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 132).
rust_blast_asm('ASM-GAUSS', 61).
rust_blast_asm('ASM-LOWDIM', 64).
rust_blast_asm('ASM-WICK', 1).
rust_blast_asm('ASM-ENVARIANCE', 1).
rust_blast_asm('ASM-INIT', 9).
rust_blast_asm('ASM-DOF-GROWTH', 7).
rust_blast_asm('ASM-SIGMA-DATA', 52).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 40).
rust_blast_asm('ASM-DIAGPAIR', 58).
rust_blast_asm('ASM-GAUGE-GROUP', 36).
rust_blast_asm('ASM-CHIRALITY', 34).
rust_blast_asm('ASM-ALL-CHARGED', 34).
rust_blast_asm('ASM-EFT-VALIDITY', 29).
rust_blast_asm('ASM-SMCONTENT', 15).
rust_blast_asm('ASM-TORUS', 63).
rust_blast_asm('ASM-OVERLAP', 60).
rust_blast_asm('ASM-WILSON-GRID', 60).
rust_blast_asm('ASM-WINDOW-V31', 29).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 16).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 35).
rust_blast_asm('ASM-PDG', 68).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 75).
rust_blast_asm('ASM-PRIOR', 63).
rust_blast_asm('ASM-STABLE-LABEL', 59).
rust_blast_asm('ASM-MODK', 48).
rust_blast_asm('ASM-Z2-MINIMAL', 13).
rust_blast_asm('ASM-EDGE-SEMANTICS', 13).
rust_blast_asm('ASM-LEAN-TRUST', 8).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 2).
rust_blast_fal('FAL-BMV', 46).
rust_blast_fal('FAL-PAGE', 5).
rust_blast_fal('FAL-LORENTZ', 5).
rust_blast_fal('FAL-DIMFLOW', 4).
rust_blast_fal('FAL-GLOBALSYM', 3).
rust_blast_fal('FAL-AREALAW', 38).
rust_blast_fal('FAL-EXOTIC-CHIRAL', 29).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 14).
rust_blast_fal('FAL-CKM-OOS', 61).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 176).
rust_blast_fal('FAL-CEX-WINDOW', 40).
rust_blast_fal('FAL-QNEC', 16).
rust_blast_fal('FAL-CONTINUUM', 87).
