...
rust_closure('QRN-GEOM-003', 16).
rust_depth('QRN-GRAV-001', 1).
rust_closure('QRN-GRAV-001', 11).
...
rust_closure('QRN-MATTER-001', 54).
...
rust_closure('QRN-EXP-001', 35).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 22).
...
rust_closure('QRN-YUK-003', 51).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 33).
...
rust_closure('QRN-YUK-005', 47).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 46).
...
rust_closure('QRN-YUK-022', 24).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 23).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 22).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 16).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 16).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 15).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 14).
rust_depth('QRN-META-017', 18).
rust_closure('QRN-META-017', 3).
rust_depth('QRN-YUK-026', 16).
rust_closure('QRN-YUK-026', 0).
rust_depth('QRN-YUK-027', 15).
rust_closure('QRN-YUK-027', 15).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 13).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 12).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 11).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 11).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 10).
rust_depth('QRN-YUK-030', 21).
rust_closure('QRN-YUK-030', 3).
rust_depth('QRN-META-018', 22).
rust_closure('QRN-META-018', 2).
rust_depth('QRN-YUK-031', 21).
rust_closure('QRN-YUK-031', 2).
rust_depth('QRN-LEP-001', 21).
rust_closure('QRN-LEP-001', 6).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 5).
rust_depth('QRN-LEP-003', 23).
rust_closure('QRN-LEP-003', 4).
rust_depth('QRN-LEP-004', 24).
rust_closure('QRN-LEP-004', 3).
rust_depth('QRN-LEP-005', 25).
rust_closure('QRN-LEP-005', 2).
rust_depth('QRN-META-019', 26).
rust_closure('QRN-META-019', 1).
rust_depth('QRN-GRAV-005', 2).
rust_closure('QRN-GRAV-005', 7).
rust_depth('QRN-GRAV-006', 3).
rust_closure('QRN-GRAV-006', 3).
rust_depth('QRN-GRAV-007', 3).
rust_closure('QRN-GRAV-007', 2).
rust_depth('QRN-GRAV-008', 4).
rust_closure('QRN-GRAV-008', 2).
rust_depth('QRN-GRAV-009', 3).
rust_closure('QRN-GRAV-009', 1).
rust_depth('QRN-GRAV-010', 5).
rust_closure('QRN-GRAV-010', 1).
rust_depth('QRN-GRAV-011', 4).
rust_closure('QRN-GRAV-011', 1).
rust_depth('QRN-META-020', 27).
rust_closure('QRN-META-020', 0).
rust_depth('QRN-CORE-006', 0).
rust_closure('QRN-CORE-006', 5).
rust_depth('QRN-CORE-007', 1).
rust_closure('QRN-CORE-007', 0).
rust_depth('QRN-CORE-008', 1).
rust_closure('QRN-CORE-008', 0).
rust_depth('QRN-CORE-009', 1).
rust_closure('QRN-CORE-009', 0).
rust_depth('QRN-CORE-010', 1).
rust_closure('QRN-CORE-010', 1).
rust_depth('QRN-CORE-011', 2).
rust_closure('QRN-CORE-011', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 101).
rust_blast_asm('ASM-GAUSS', 42).
rust_blast_asm('ASM-LOWDIM', 45).
rust_blast_asm('ASM-WICK', 1).
rust_blast_asm('ASM-ENVARIANCE', 1).
rust_blast_asm('ASM-INIT', 9).
rust_blast_asm('ASM-DOF-GROWTH', 7).
rust_blast_asm('ASM-SIGMA-DATA', 45).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 34).
rust_blast_asm('ASM-DIAGPAIR', 52).
rust_blast_asm('ASM-GAUGE-GROUP', 30).
rust_blast_asm('ASM-CHIRALITY', 28).
rust_blast_asm('ASM-ALL-CHARGED', 28).
rust_blast_asm('ASM-EFT-VALIDITY', 23).
rust_blast_asm('ASM-SMCONTENT', 9).
rust_blast_asm('ASM-TORUS', 56).
rust_blast_asm('ASM-OVERLAP', 53).
rust_blast_asm('ASM-WILSON-GRID', 53).
rust_blast_asm('ASM-WINDOW-V31', 23).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 10).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 29).
rust_blast_asm('ASM-PDG', 61).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 69).
rust_blast_asm('ASM-PRIOR', 56).
rust_blast_asm('ASM-STABLE-LABEL', 52).
rust_blast_asm('ASM-MODK', 25).
rust_blast_asm('ASM-Z2-MINIMAL', 7).
rust_blast_asm('ASM-EDGE-SEMANTICS', 7).
rust_blast_asm('ASM-LEAN-TRUST', 7).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_fal('FAL-BMV', 39).
rust_blast_fal('FAL-PAGE', 5).
rust_blast_fal('FAL-LORENTZ', 4).
rust_blast_fal('FAL-DIMFLOW', 4).
rust_blast_fal('FAL-GLOBALSYM', 3).
rust_blast_fal('FAL-AREALAW', 19).
rust_blast_fal('FAL-EXOTIC-CHIRAL', 23).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 8).
rust_blast_fal('FAL-CKM-OOS', 55).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 141).
rust_blast_fal('FAL-CEX-WINDOW', 34).
rust_blast_fal('FAL-QNEC', 10).
rust_blast_fal('FAL-CONTINUUM', 59).
