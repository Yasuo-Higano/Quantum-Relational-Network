...
rust_closure('QRN-C0-005', 69).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 53).
...
rust_closure('QRN-MATTER-001', 51).
...
rust_closure('QRN-EXP-001', 32).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 19).
...
rust_closure('QRN-YUK-003', 48).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 30).
...
rust_closure('QRN-YUK-005', 44).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 43).
...
rust_closure('QRN-YUK-017', 26).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 25).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 24).
...
rust_closure('QRN-YUK-022', 21).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 20).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 19).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 13).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 13).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 12).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 11).
...
rust_closure('QRN-YUK-027', 12).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 10).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 9).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 8).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 8).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 7).
...
rust_closure('QRN-LEP-001', 3).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 2).
rust_depth('QRN-LEP-003', 23).
rust_closure('QRN-LEP-003', 1).
rust_depth('QRN-LEP-004', 24).
rust_closure('QRN-LEP-004', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 85).
...
rust_blast_asm('ASM-SIGMA-DATA', 42).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 31).
rust_blast_asm('ASM-DIAGPAIR', 49).
rust_blast_asm('ASM-GAUGE-GROUP', 27).
rust_blast_asm('ASM-CHIRALITY', 25).
rust_blast_asm('ASM-ALL-CHARGED', 25).
rust_blast_asm('ASM-EFT-VALIDITY', 20).
rust_blast_asm('ASM-SMCONTENT', 6).
rust_blast_asm('ASM-TORUS', 53).
rust_blast_asm('ASM-OVERLAP', 50).
rust_blast_asm('ASM-WILSON-GRID', 50).
rust_blast_asm('ASM-WINDOW-V31', 20).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 7).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 26).
rust_blast_asm('ASM-PDG', 58).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 66).
rust_blast_asm('ASM-PRIOR', 53).
rust_blast_asm('ASM-STABLE-LABEL', 49).
...
rust_blast_fal('FAL-EXOTIC-CHIRAL', 20).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 5).
rust_blast_fal('FAL-CKM-OOS', 52).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 125).
rust_blast_fal('FAL-CEX-WINDOW', 31).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 43).
