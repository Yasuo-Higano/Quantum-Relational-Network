...
rust_closure('QRN-C0-005', 45).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 29).
...
rust_closure('QRN-MATTER-001', 27).
...
rust_closure('QRN-YUK-003', 24).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 6).
...
rust_closure('QRN-YUK-005', 20).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 19).
...
rust_closure('QRN-YUK-017', 2).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 1).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 61).
...
rust_blast_asm('ASM-SIGMA-DATA', 18).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 7).
rust_blast_asm('ASM-DIAGPAIR', 25).
...
rust_blast_asm('ASM-TORUS', 29).
rust_blast_asm('ASM-OVERLAP', 26).
rust_blast_asm('ASM-WILSON-GRID', 26).
...
rust_blast_asm('ASM-PDG', 34).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 42).
rust_blast_asm('ASM-PRIOR', 29).
rust_blast_asm('ASM-STABLE-LABEL', 25).
...
rust_blast_fal('FAL-CKM-OOS', 28).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 101).
