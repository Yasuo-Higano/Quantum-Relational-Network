...
rust_closure('QRN-C0-005', 65).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 49).
...
rust_closure('QRN-MATTER-001', 47).
...
rust_closure('QRN-EXP-001', 28).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 15).
...
rust_closure('QRN-YUK-003', 44).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 26).
...
rust_closure('QRN-YUK-005', 40).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 39).
...
rust_closure('QRN-YUK-017', 22).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 21).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 20).
...
rust_closure('QRN-YUK-022', 17).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 16).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 15).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 9).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 9).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 8).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 7).
...
rust_closure('QRN-YUK-027', 8).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 6).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 5).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 4).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 4).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 3).
...
rust_blast_asm('ASM-SIGMA-DATA', 38).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 27).
rust_blast_asm('ASM-DIAGPAIR', 45).
rust_blast_asm('ASM-GAUGE-GROUP', 23).
rust_blast_asm('ASM-CHIRALITY', 21).
rust_blast_asm('ASM-ALL-CHARGED', 21).
rust_blast_asm('ASM-EFT-VALIDITY', 16).
rust_blast_asm('ASM-SMCONTENT', 2).
rust_blast_asm('ASM-TORUS', 49).
rust_blast_asm('ASM-OVERLAP', 46).
rust_blast_asm('ASM-WILSON-GRID', 46).
rust_blast_asm('ASM-WINDOW-V31', 16).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 3).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 22).
rust_blast_asm('ASM-PDG', 54).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 62).
rust_blast_asm('ASM-PRIOR', 49).
rust_blast_asm('ASM-STABLE-LABEL', 45).
...
rust_blast_fal('FAL-EXOTIC-CHIRAL', 16).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 1).
rust_blast_fal('FAL-CKM-OOS', 48).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 121).
rust_blast_fal('FAL-CEX-WINDOW', 27).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 39).
