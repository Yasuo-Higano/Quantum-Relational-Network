...
rust_blast_asm('ASM-GAUSS', 86).
rust_blast_asm('ASM-LOWDIM', 84).
...
rust_blast_asm('ASM-EDGE-SEMANTICS', 36).
rust_blast_asm('ASM-LEAN-TRUST', 28).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 35).
rust_blast_asm('ASM-LAYER-SEMANTICS', 22).
