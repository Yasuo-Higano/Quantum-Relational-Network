...
rust_closure('QRN-C0-005', 64).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 48).
...
rust_closure('QRN-MATTER-001', 46).
...
rust_closure('QRN-YUK-003', 43).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 25).
...
rust_closure('QRN-YUK-005', 39).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 38).
...
rust_closure('QRN-YUK-017', 21).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 20).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 19).
...
rust_closure('QRN-YUK-022', 16).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 15).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 14).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 8).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 8).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 7).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 6).
...
rust_closure('QRN-YUK-027', 7).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 5).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 4).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 3).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 3).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 2).
...
rust_blast_asm('ASM-SIGMA-DATA', 37).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 26).
rust_blast_asm('ASM-DIAGPAIR', 44).
...
rust_blast_asm('ASM-TORUS', 48).
rust_blast_asm('ASM-OVERLAP', 45).
rust_blast_asm('ASM-WILSON-GRID', 45).
...
rust_blast_asm('ASM-PDG', 53).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 61).
rust_blast_asm('ASM-PRIOR', 48).
rust_blast_asm('ASM-STABLE-LABEL', 44).
...
rust_blast_fal('FAL-CKM-OOS', 47).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 120).
rust_blast_fal('FAL-CEX-WINDOW', 27).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 38).
