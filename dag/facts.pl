...
rust_closure('QRN-C0-001', 9).
rust_depth('QRN-C0-002', 0).
rust_closure('QRN-C0-002', 8).
...
rust_blast_asm('ASM-LATTICE', 87).
rust_blast_asm('ASM-GAUSS', 34).
rust_blast_asm('ASM-LOWDIM', 37).
...
rust_blast_fal('FAL-SUITE', 127).
rust_blast_fal('FAL-CEX-WINDOW', 33).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 45).
