...
rust_closure('QRN-GRAV-043', 3).
rust_depth('QRN-GRAV-044', 2).
rust_closure('QRN-GRAV-044', 2).
rust_depth('QRN-GRAV-045', 3).
rust_closure('QRN-GRAV-045', 1).
rust_depth('QRN-GRAV-046', 4).
rust_closure('QRN-GRAV-046', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 146).
