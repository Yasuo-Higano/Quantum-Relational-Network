...
rust_closure('QRN-C0-005', 62).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 46).
...
rust_closure('QRN-MATTER-001', 44).
...
rust_closure('QRN-YUK-003', 41).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 23).
...
rust_closure('QRN-YUK-005', 37).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 36).
...
rust_closure('QRN-YUK-017', 19).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 18).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 17).
...
rust_closure('QRN-YUK-022', 14).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 13).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 12).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 6).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 6).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 5).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 4).
...
rust_closure('QRN-YUK-027', 5).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 3).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 2).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 1).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 1).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 78).
...
rust_blast_asm('ASM-SIGMA-DATA', 35).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 24).
rust_blast_asm('ASM-DIAGPAIR', 42).
...
rust_blast_asm('ASM-TORUS', 46).
rust_blast_asm('ASM-OVERLAP', 43).
rust_blast_asm('ASM-WILSON-GRID', 43).
...
rust_blast_asm('ASM-PDG', 51).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 59).
rust_blast_asm('ASM-PRIOR', 46).
rust_blast_asm('ASM-STABLE-LABEL', 42).
...
rust_blast_fal('FAL-CKM-OOS', 45).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 118).
rust_blast_fal('FAL-CEX-WINDOW', 27).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 36).
