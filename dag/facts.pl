...
rust_closure('QRN-CAUSAL-001', 19).
rust_depth('QRN-CAUSAL-002', 1).
rust_closure('QRN-CAUSAL-002', 16).
rust_depth('QRN-ER-001', 0).
rust_closure('QRN-ER-001', 12).
...
rust_blast_fal('FAL-SUITE', 218).
rust_blast_fal('FAL-CEX-WINDOW', 41).
rust_blast_fal('FAL-QNEC', 17).
rust_blast_fal('FAL-CONTINUUM', 96).
