...
rust_blast_asm('ASM-EDGE-SEMANTICS', 40).
rust_blast_asm('ASM-LEAN-TRUST', 32).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 38).
rust_blast_asm('ASM-LAYER-SEMANTICS', 26).
