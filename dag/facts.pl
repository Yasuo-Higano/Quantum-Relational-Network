...
rust_closure('QRN-C0-001', 26).
rust_depth('QRN-C0-002', 0).
rust_closure('QRN-C0-002', 25).
...
rust_closure('QRN-GRAV-013', 3).
rust_depth('QRN-GRAV-014', 7).
rust_closure('QRN-GRAV-014', 2).
rust_depth('QRN-GRAV-015', 8).
rust_closure('QRN-GRAV-015', 1).
rust_depth('QRN-GRAV-016', 9).
rust_closure('QRN-GRAV-016', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 113).
rust_blast_asm('ASM-GAUSS', 51).
rust_blast_asm('ASM-LOWDIM', 54).
...
rust_blast_fal('FAL-SUITE', 154).
rust_blast_fal('FAL-CEX-WINDOW', 37).
rust_blast_fal('FAL-QNEC', 13).
rust_blast_fal('FAL-CONTINUUM', 71).
