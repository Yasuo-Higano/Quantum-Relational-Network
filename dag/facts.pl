...
rust_closure('QRN-C0-005', 55).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 39).
...
rust_closure('QRN-MATTER-001', 37).
...
rust_closure('QRN-YUK-003', 34).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 16).
...
rust_closure('QRN-YUK-005', 30).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 29).
...
rust_closure('QRN-YUK-017', 12).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 11).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 10).
...
rust_closure('QRN-YUK-022', 7).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 6).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 5).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 1).
...
rust_blast_asm('ASM-SIGMA-DATA', 28).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 17).
rust_blast_asm('ASM-DIAGPAIR', 35).
...
rust_blast_asm('ASM-TORUS', 39).
rust_blast_asm('ASM-OVERLAP', 36).
rust_blast_asm('ASM-WILSON-GRID', 36).
...
rust_blast_asm('ASM-PDG', 44).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 52).
rust_blast_asm('ASM-PRIOR', 39).
rust_blast_asm('ASM-STABLE-LABEL', 35).
...
rust_blast_fal('FAL-CKM-OOS', 38).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 111).
rust_blast_fal('FAL-CEX-WINDOW', 27).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 29).
