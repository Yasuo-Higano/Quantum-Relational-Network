...
rust_closure('QRN-C0-005', 56).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 40).
...
rust_closure('QRN-MATTER-001', 38).
...
rust_closure('QRN-YUK-003', 35).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 17).
...
rust_closure('QRN-YUK-005', 31).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 30).
...
rust_closure('QRN-YUK-017', 13).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 12).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 11).
...
rust_closure('QRN-YUK-022', 8).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 7).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 6).
...
rust_blast_asm('ASM-SIGMA-DATA', 29).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 18).
rust_blast_asm('ASM-DIAGPAIR', 36).
...
rust_blast_asm('ASM-TORUS', 40).
rust_blast_asm('ASM-OVERLAP', 37).
rust_blast_asm('ASM-WILSON-GRID', 37).
...
rust_blast_asm('ASM-PDG', 45).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 53).
rust_blast_asm('ASM-PRIOR', 40).
rust_blast_asm('ASM-STABLE-LABEL', 36).
...
rust_blast_fal('FAL-CKM-OOS', 39).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 112).
rust_blast_fal('FAL-CEX-WINDOW', 27).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 30).
