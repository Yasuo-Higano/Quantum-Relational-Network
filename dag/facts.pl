...
rust_blast_asm('ASM-GAUSS', 97).
rust_blast_asm('ASM-LOWDIM', 96).
...
rust_blast_asm('ASM-EDGE-SEMANTICS', 48).
rust_blast_asm('ASM-LEAN-TRUST', 40).
rust_blast_asm('ASM-NET-REAL', 7).
rust_blast_asm('ASM-IEEE754', 47).
rust_blast_asm('ASM-LAYER-SEMANTICS', 34).
