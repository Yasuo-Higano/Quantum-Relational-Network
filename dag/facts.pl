...
rust_closure('QRN-C0-005', 67).
rust_depth('QRN-C0-006', 0).
rust_closure('QRN-C0-006', 51).
...
rust_closure('QRN-MATTER-001', 49).
...
rust_closure('QRN-EXP-001', 30).
rust_depth('QRN-GAUGE-003', 1).
rust_closure('QRN-GAUGE-003', 17).
...
rust_closure('QRN-YUK-003', 46).
rust_depth('QRN-EXP-003', 1).
rust_closure('QRN-EXP-003', 28).
...
rust_closure('QRN-YUK-005', 42).
rust_depth('QRN-YUK-006', 6).
rust_closure('QRN-YUK-006', 41).
...
rust_closure('QRN-YUK-017', 24).
rust_depth('QRN-YUK-018', 10).
rust_closure('QRN-YUK-018', 23).
rust_depth('QRN-YUK-019', 11).
rust_closure('QRN-YUK-019', 22).
...
rust_closure('QRN-YUK-022', 19).
rust_depth('QRN-YUK-023', 13).
rust_closure('QRN-YUK-023', 18).
rust_depth('QRN-YUK-024', 14).
rust_closure('QRN-YUK-024', 17).
rust_depth('QRN-YUK-025', 15).
rust_closure('QRN-YUK-025', 11).
rust_depth('QRN-SEL-002', 15).
rust_closure('QRN-SEL-002', 11).
rust_depth('QRN-SEL-003', 16).
rust_closure('QRN-SEL-003', 10).
rust_depth('QRN-SEL-004', 17).
rust_closure('QRN-SEL-004', 9).
...
rust_closure('QRN-YUK-027', 10).
rust_depth('QRN-MSR-001', 16).
rust_closure('QRN-MSR-001', 8).
rust_depth('QRN-MSR-002', 18).
rust_closure('QRN-MSR-002', 7).
rust_depth('QRN-MSR-003', 19).
rust_closure('QRN-MSR-003', 6).
rust_depth('QRN-YUK-028', 16).
rust_closure('QRN-YUK-028', 6).
rust_depth('QRN-YUK-029', 20).
rust_closure('QRN-YUK-029', 5).
...
rust_closure('QRN-LEP-001', 1).
rust_depth('QRN-LEP-002', 22).
rust_closure('QRN-LEP-002', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 83).
...
rust_blast_asm('ASM-SIGMA-DATA', 40).
rust_blast_asm('ASM-ORBIFOLD', 3).
rust_blast_asm('ASM-KTM', 29).
rust_blast_asm('ASM-DIAGPAIR', 47).
rust_blast_asm('ASM-GAUGE-GROUP', 25).
rust_blast_asm('ASM-CHIRALITY', 23).
rust_blast_asm('ASM-ALL-CHARGED', 23).
rust_blast_asm('ASM-EFT-VALIDITY', 18).
rust_blast_asm('ASM-SMCONTENT', 4).
rust_blast_asm('ASM-TORUS', 51).
rust_blast_asm('ASM-OVERLAP', 48).
rust_blast_asm('ASM-WILSON-GRID', 48).
rust_blast_asm('ASM-WINDOW-V31', 18).
rust_blast_asm('ASM-WINDOW-V43', 7).
rust_blast_asm('ASM-WINDOW-EXT', 8).
rust_blast_asm('ASM-WINDOW-U1SQ', 5).
rust_blast_asm('ASM-WINDOW-U1CUBE', 4).
rust_blast_asm('ASM-WINDOW-EXC', 2).
rust_blast_asm('ASM-WINDOW-PAIR', 5).
rust_blast_asm('ASM-ANOMALY-COEFS', 24).
rust_blast_asm('ASM-PDG', 56).
rust_blast_asm('ASM-OBS-FRACTIONAL', 7).
rust_blast_asm('ASM-SEED', 64).
rust_blast_asm('ASM-PRIOR', 51).
rust_blast_asm('ASM-STABLE-LABEL', 47).
...
rust_blast_fal('FAL-EXOTIC-CHIRAL', 18).
rust_blast_fal('FAL-SUSY', 1).
rust_blast_fal('FAL-NEUTRINO', 3).
rust_blast_fal('FAL-CKM-OOS', 50).
rust_blast_fal('FAL-COSMO', 2).
rust_blast_fal('FAL-SUITE', 123).
rust_blast_fal('FAL-CEX-WINDOW', 29).
rust_blast_fal('FAL-QNEC', 8).
rust_blast_fal('FAL-CONTINUUM', 41).
