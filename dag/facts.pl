...
rust_closure('QRN-GRAV-043', 1).
rust_depth('QRN-GRAV-044', 2).
rust_closure('QRN-GRAV-044', 0).
rust_blast_asm('ASM-QM', 0).
rust_blast_asm('ASM-LATTICE', 144).
