...
主張 106 / 依存辺 130 / 仮定 38 / 反証条件 15 / 最大深さ 11

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 60 |
| ASM-SEED | design | 41 |
...
| ASM-TORUS | model | 28 |
| ASM-PRIOR | design | 28 |
| ASM-WILSON-GRID | design | 25 |
| ASM-OVERLAP | model | 25 |
| ASM-STABLE-LABEL | convention | 24 |
| ASM-DIAGPAIR | model | 24 |
| ASM-GAUGE-GROUP | model | 23 |
| ASM-ANOMALY-COEFS | data | 22 |
| ASM-CHIRALITY | model | 21 |
| ASM-ALL-CHARGED | definition | 21 |
| ASM-SIGMA-DATA | model | 17 |
