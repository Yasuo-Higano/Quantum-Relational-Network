...
主張 125 / 依存辺 177 / 仮定 38 / 反証条件 15 / 最大深さ 21

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 79 |
| ASM-SEED | design | 60 |
| ASM-PDG | data | 52 |
| ASM-TORUS | model | 47 |
| ASM-PRIOR | design | 47 |
| ASM-WILSON-GRID | design | 44 |
| ASM-OVERLAP | model | 44 |
| ASM-STABLE-LABEL | convention | 43 |
| ASM-DIAGPAIR | model | 43 |
| ASM-SIGMA-DATA | model | 36 |
