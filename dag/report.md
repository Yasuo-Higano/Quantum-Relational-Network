...
主張 119 / 依存辺 162 / 仮定 38 / 反証条件 15 / 最大深さ 18

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 73 |
| ASM-SEED | design | 54 |
| ASM-PDG | data | 46 |
| ASM-TORUS | model | 41 |
| ASM-PRIOR | design | 41 |
| ASM-WILSON-GRID | design | 38 |
| ASM-OVERLAP | model | 38 |
| ASM-STABLE-LABEL | convention | 37 |
| ASM-DIAGPAIR | model | 37 |
| ASM-LOWDIM | framework | 35 |
| ASM-GAUSS | framework | 32 |
| ASM-SIGMA-DATA | model | 30 |
