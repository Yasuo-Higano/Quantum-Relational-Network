...
主張 110 / 依存辺 134 / 仮定 38 / 反証条件 15 / 最大深さ 12

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 64 |
| ASM-SEED | design | 45 |
| ASM-PDG | data | 37 |
...
| ASM-WILSON-GRID | design | 29 |
| ASM-OVERLAP | model | 29 |
| ASM-STABLE-LABEL | convention | 28 |
| ASM-DIAGPAIR | model | 28 |
| ASM-GAUGE-GROUP | model | 23 |
| ASM-ANOMALY-COEFS | data | 22 |
| ASM-SIGMA-DATA | model | 21 |
