...
主張 228 / 依存辺 391 / 仮定 40 / 反証条件 15 / 最大深さ 34

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 172 |
| ASM-SEED | design | 79 |
| ASM-LOWDIM | framework | 75 |
| ASM-GAUSS | framework | 72 |
| ASM-PDG | data | 70 |
| ASM-TORUS | model | 65 |
| ASM-PRIOR | design | 65 |
