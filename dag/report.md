...
主張 107 / 依存辺 131 / 仮定 38 / 反証条件 15 / 最大深さ 11

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 61 |
| ASM-SEED | design | 42 |
| ASM-PDG | data | 34 |
...
| ASM-TORUS | model | 29 |
| ASM-PRIOR | design | 29 |
| ASM-WILSON-GRID | design | 26 |
| ASM-OVERLAP | model | 26 |
| ASM-STABLE-LABEL | convention | 25 |
| ASM-DIAGPAIR | model | 25 |
| ASM-GAUGE-GROUP | model | 23 |
| ASM-ANOMALY-COEFS | data | 22 |
| ASM-CHIRALITY | model | 21 |
| ASM-ALL-CHARGED | definition | 21 |
| ASM-SIGMA-DATA | model | 18 |
