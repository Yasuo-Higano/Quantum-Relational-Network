...
主張 126 / 依存辺 182 / 仮定 38 / 反証条件 15 / 最大深さ 22

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 80 |
| ASM-SEED | design | 61 |
| ASM-PDG | data | 53 |
| ASM-TORUS | model | 48 |
| ASM-PRIOR | design | 48 |
| ASM-WILSON-GRID | design | 45 |
| ASM-OVERLAP | model | 45 |
| ASM-STABLE-LABEL | convention | 44 |
| ASM-DIAGPAIR | model | 44 |
| ASM-SIGMA-DATA | model | 37 |
