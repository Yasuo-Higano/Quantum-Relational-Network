...
主張 122 / 依存辺 171 / 仮定 38 / 反証条件 15 / 最大深さ 19

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 76 |
| ASM-SEED | design | 57 |
| ASM-PDG | data | 49 |
| ASM-TORUS | model | 44 |
| ASM-PRIOR | design | 44 |
| ASM-WILSON-GRID | design | 41 |
| ASM-OVERLAP | model | 41 |
| ASM-STABLE-LABEL | convention | 40 |
| ASM-DIAGPAIR | model | 40 |
| ASM-LOWDIM | framework | 35 |
| ASM-SIGMA-DATA | model | 33 |
