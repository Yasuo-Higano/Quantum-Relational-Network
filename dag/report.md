...
主張 115 / 依存辺 145 / 仮定 38 / 反証条件 15 / 最大深さ 16

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 69 |
| ASM-SEED | design | 50 |
| ASM-PDG | data | 42 |
| ASM-TORUS | model | 37 |
| ASM-PRIOR | design | 37 |
| ASM-WILSON-GRID | design | 34 |
| ASM-OVERLAP | model | 34 |
| ASM-LOWDIM | framework | 34 |
| ASM-STABLE-LABEL | convention | 33 |
| ASM-DIAGPAIR | model | 33 |
| ASM-GAUSS | framework | 31 |
| ASM-SIGMA-DATA | model | 26 |
