...
主張 256 / 依存辺 436 / 仮定 40 / 反証条件 15 / 最大深さ 34
...
| ASM-GAUSS | framework | 95 |
| ASM-LOWDIM | framework | 94 |
| ASM-SEED | design | 89 |
| ASM-PDG | data | 70 |
| ASM-TORUS | model | 65 |
| ASM-PRIOR | design | 65 |
...
| ASM-EDGE-SEMANTICS | design | 46 |
| ASM-IEEE754 | trust | 45 |
| ASM-KTM | model | 42 |
| ASM-LEAN-TRUST | trust | 38 |
| ASM-GAUGE-GROUP | model | 37 |
| ASM-ANOMALY-COEFS | data | 36 |
| ASM-CHIRALITY | model | 35 |
| ASM-ALL-CHARGED | definition | 35 |
| ASM-LAYER-SEMANTICS | convention | 32 |
