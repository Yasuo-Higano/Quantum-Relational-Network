...
主張 185 / 依存辺 306 / 仮定 39 / 反証条件 15 / 最大深さ 34

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 133 |
| ASM-SEED | design | 76 |
| ASM-PDG | data | 69 |
...
| ASM-WILSON-GRID | design | 61 |
| ASM-OVERLAP | model | 61 |
| ASM-STABLE-LABEL | convention | 60 |
| ASM-DIAGPAIR | model | 59 |
| ASM-SIGMA-DATA | model | 53 |
