...
主張 104 / 依存辺 126 / 仮定 38 / 反証条件 15 / 最大深さ 11

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 58 |
| ASM-SEED | design | 39 |
...
| ASM-TORUS | model | 26 |
| ASM-PRIOR | design | 26 |
| ASM-WILSON-GRID | design | 23 |
| ASM-OVERLAP | model | 23 |
| ASM-GAUGE-GROUP | model | 23 |
| ASM-STABLE-LABEL | convention | 22 |
| ASM-DIAGPAIR | model | 22 |
