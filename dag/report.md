...
主張 111 / 依存辺 136 / 仮定 38 / 反証条件 15 / 最大深さ 13

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 65 |
| ASM-SEED | design | 46 |
| ASM-PDG | data | 38 |
...
| ASM-WILSON-GRID | design | 30 |
| ASM-OVERLAP | model | 30 |
| ASM-STABLE-LABEL | convention | 29 |
| ASM-DIAGPAIR | model | 29 |
| ASM-GAUGE-GROUP | model | 23 |
| ASM-SIGMA-DATA | model | 22 |
