...
主張 120 / 依存辺 165 / 仮定 38 / 反証条件 15 / 最大深さ 18

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 74 |
| ASM-SEED | design | 55 |
| ASM-PDG | data | 47 |
| ASM-TORUS | model | 42 |
| ASM-PRIOR | design | 42 |
| ASM-WILSON-GRID | design | 39 |
| ASM-OVERLAP | model | 39 |
| ASM-STABLE-LABEL | convention | 38 |
| ASM-DIAGPAIR | model | 38 |
| ASM-LOWDIM | framework | 35 |
| ASM-GAUSS | framework | 32 |
| ASM-SIGMA-DATA | model | 31 |
