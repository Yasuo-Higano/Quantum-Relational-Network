...
主張 108 / 依存辺 132 / 仮定 38 / 反証条件 15 / 最大深さ 12

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 62 |
| ASM-SEED | design | 43 |
| ASM-PDG | data | 35 |
...
| ASM-TORUS | model | 30 |
| ASM-PRIOR | design | 30 |
| ASM-WILSON-GRID | design | 27 |
| ASM-OVERLAP | model | 27 |
| ASM-STABLE-LABEL | convention | 26 |
| ASM-DIAGPAIR | model | 26 |
| ASM-GAUGE-GROUP | model | 23 |
| ASM-ANOMALY-COEFS | data | 22 |
| ASM-CHIRALITY | model | 21 |
| ASM-ALL-CHARGED | definition | 21 |
| ASM-SIGMA-DATA | model | 19 |
