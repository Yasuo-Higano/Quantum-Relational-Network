...
主張 113 / 依存辺 140 / 仮定 38 / 反証条件 15 / 最大深さ 15

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 67 |
| ASM-SEED | design | 48 |
| ASM-PDG | data | 40 |
| ASM-TORUS | model | 35 |
| ASM-PRIOR | design | 35 |
| ASM-LOWDIM | framework | 34 |
| ASM-WILSON-GRID | design | 32 |
| ASM-OVERLAP | model | 32 |
| ASM-STABLE-LABEL | convention | 31 |
| ASM-GAUSS | framework | 31 |
| ASM-DIAGPAIR | model | 31 |
| ASM-SIGMA-DATA | model | 24 |
