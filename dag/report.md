...
主張 121 / 依存辺 167 / 仮定 38 / 反証条件 15 / 最大深さ 18

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 75 |
| ASM-SEED | design | 56 |
| ASM-PDG | data | 48 |
| ASM-TORUS | model | 43 |
| ASM-PRIOR | design | 43 |
| ASM-WILSON-GRID | design | 40 |
| ASM-OVERLAP | model | 40 |
| ASM-STABLE-LABEL | convention | 39 |
| ASM-DIAGPAIR | model | 39 |
| ASM-LOWDIM | framework | 35 |
| ASM-SIGMA-DATA | model | 32 |
