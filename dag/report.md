...
主張 124 / 依存辺 175 / 仮定 38 / 反証条件 15 / 最大深さ 20

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 78 |
| ASM-SEED | design | 59 |
| ASM-PDG | data | 51 |
| ASM-TORUS | model | 46 |
| ASM-PRIOR | design | 46 |
| ASM-WILSON-GRID | design | 43 |
| ASM-OVERLAP | model | 43 |
| ASM-STABLE-LABEL | convention | 42 |
| ASM-DIAGPAIR | model | 42 |
| ASM-SIGMA-DATA | model | 35 |
