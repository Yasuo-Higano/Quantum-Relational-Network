...
主張 114 / 依存辺 142 / 仮定 38 / 反証条件 15 / 最大深さ 15

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 68 |
| ASM-SEED | design | 49 |
| ASM-PDG | data | 41 |
| ASM-TORUS | model | 36 |
| ASM-PRIOR | design | 36 |
| ASM-LOWDIM | framework | 34 |
| ASM-WILSON-GRID | design | 33 |
| ASM-OVERLAP | model | 33 |
| ASM-STABLE-LABEL | convention | 32 |
| ASM-DIAGPAIR | model | 32 |
| ASM-GAUSS | framework | 31 |
| ASM-SIGMA-DATA | model | 25 |
