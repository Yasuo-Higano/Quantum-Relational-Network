...
主張 131 / 依存辺 190 / 仮定 38 / 反証条件 15 / 最大深さ 24

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 85 |
| ASM-SEED | design | 66 |
| ASM-PDG | data | 58 |
| ASM-TORUS | model | 53 |
| ASM-PRIOR | design | 53 |
| ASM-WILSON-GRID | design | 50 |
| ASM-OVERLAP | model | 50 |
| ASM-STABLE-LABEL | convention | 49 |
| ASM-DIAGPAIR | model | 49 |
| ASM-SIGMA-DATA | model | 42 |
| ASM-LOWDIM | framework | 36 |
| ASM-GAUSS | framework | 33 |
| ASM-KTM | model | 31 |
| ASM-GAUGE-GROUP | model | 27 |
| ASM-ANOMALY-COEFS | data | 26 |
| ASM-CHIRALITY | model | 25 |
| ASM-ALL-CHARGED | definition | 25 |
| ASM-WINDOW-V31 | window | 20 |
| ASM-EFT-VALIDITY | model | 20 |
| ASM-MODK | definition | 16 |
| ASM-INIT | model | 9 |
| ASM-WINDOW-EXT | window | 8 |
| ASM-WINDOW-V43 | window | 7 |
| ASM-WINDOW-U1SQ | window | 7 |
| ASM-OBS-FRACTIONAL | observational | 7 |
| ASM-NET-REAL | ontology | 7 |
| ASM-LEAN-TRUST | trust | 7 |
| ASM-DOF-GROWTH | model | 7 |
| ASM-SMCONTENT | data | 6 |
...
| FAL-SUITE | open | 125 |
| FAL-CKM-OOS | open | 52 |
| FAL-CONTINUUM | open | 43 |
| FAL-BMV | open | 36 |
| FAL-CEX-WINDOW | open | 31 |
| FAL-EXOTIC-CHIRAL | open | 20 |
| FAL-AREALAW | open | 10 |
| FAL-QNEC | open | 8 |
| FAL-PAGE | open | 5 |
| FAL-NEUTRINO | open | 5 |
