...
主張 118 / 依存辺 159 / 仮定 38 / 反証条件 15 / 最大深さ 18

## 仮定の影響範囲 (抜くと落ちる主張の閉包 — 降順)

| 仮定 | type | 閉包 |
|---|---|---|
| ASM-LATTICE | framework | 72 |
| ASM-SEED | design | 53 |
| ASM-PDG | data | 45 |
| ASM-TORUS | model | 40 |
| ASM-PRIOR | design | 40 |
| ASM-WILSON-GRID | design | 37 |
| ASM-OVERLAP | model | 37 |
| ASM-STABLE-LABEL | convention | 36 |
| ASM-DIAGPAIR | model | 36 |
| ASM-LOWDIM | framework | 35 |
| ASM-GAUSS | framework | 32 |
| ASM-SIGMA-DATA | model | 29 |
