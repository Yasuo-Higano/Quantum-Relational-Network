...
主張 257 / 依存辺 438 / 仮定 40 / 反証条件 15 / 最大深さ 34
...
| ASM-GAUSS | framework | 96 |
| ASM-LOWDIM | framework | 95 |
| ASM-SEED | design | 89 |
| ASM-PDG | data | 70 |
| ASM-TORUS | model | 65 |
| ASM-PRIOR | design | 65 |
...
| ASM-EDGE-SEMANTICS | design | 47 |
| ASM-IEEE754 | trust | 46 |
| ASM-KTM | model | 42 |
| ASM-LEAN-TRUST | trust | 39 |
| ASM-GAUGE-GROUP | model | 37 |
| ASM-ANOMALY-COEFS | data | 36 |
| ASM-CHIRALITY | model | 35 |
| ASM-ALL-CHARGED | definition | 35 |
| ASM-LAYER-SEMANTICS | convention | 33 |
